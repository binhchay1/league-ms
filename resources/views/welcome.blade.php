...
<head>
    ...
    <meta name="description" content="Chuyên trang cầu lông của Flashscore cung cấp tỉ số và kết quả cầu lông trực tiếp nhanh và chính xác. Hãy theo dõi HYLO mở rộng 2023, livescore BWF World Tour Super Series, giải cầu lông Vô địch Thế giới và các giải đấu BWF trực tiếp khác!">
    ...
    <meta property="og:description" content="Chuyên trang cầu lông của Flashscore cung cấp tỉ số và kết quả cầu lông trực tiếp nhanh và chính xác. Hãy theo dõi HYLO mở rộng 2023, livescore BWF World Tour Super Series, giải cầu lông Vô địch Thế giới và các giải đấu BWF trực tiếp khác!">
    ...
    <header class="header">
        ...
        <div class="header__content">
            <a class="header__logoWrapper" href="/">
                <svg class="header__logo" preserveAspectRatio="xMinYMid meet" enable-background="new 0 0 615 100" height="100" viewBox="0 0 615 100" width="615" xmlns="http://www.w3.org/2000/svg">
    ...
    <nav class="menuTop menuTop--badminton">
        <div class="menuTop__content menuTop__group">
            ...
            <div class="menuTop__items">
                <a href="/" class="menuTop__item" data-sport-id="1">
                    <svg class="menuTop__icon">
                        <use xlink:href="/res/_fs/image/13_symbols/sport.svg#soccer"></use>
                    </svg>
                    <div class="menuTop__text">Bóng đá</div>
                </a>
                <a href="/tennis/" class="menuTop__item" data-sport-id="2">
                    <svg class="menuTop__icon">
                        <use xlink:href="/res/_fs/image/13_symbols/sport.svg#tennis"></use>
                    </svg>
                    <div class="menuTop__text">Tennis</div>
                </a>
                <a href="/cau-long/" class="menuTop__item--active menuTop__item" data-sport-id="21">
                    <svg class="menuTop__icon">
                        <use xlink:href="/res/_fs/image/13_symbols/sport.svg#badminton"></use>
                    </svg>
                    <div class="menuTop__text">Cầu lông</div>
                </a>
                <a href="/bong-ro/" class="menuTop__item" data-sport-id="3">
                    <svg class="menuTop__icon">
                        <use xlink:href="/res/_fs/image/13_symbols/sport.svg#basketball"></use>
                    </svg>
                    <div class="menuTop__text">Bóng rổ</div>
                </a>
                <a href="/bong-chuyen/" class="menuTop__item" data-sport-id="12">
                    <svg class="menuTop__icon">
                        <use xlink:href="/res/_fs/image/13_symbols/sport.svg#volleyball"></use>
                    </svg>
                    <div class="menuTop__text">Bóng chuyền</div>
                </a>
                <a href="/futsal/" class="menuTop__item" data-sport-id="11">
                    <svg class="menuTop__icon">
                        <use xlink:href="/res/_fs/image/13_symbols/sport.svg#futsal"></use>
                    </svg>
                    <div class="menuTop__text">Futsal</div>
                </a>
                <a href="/hockey/" class="menuTop__item" data-sport-id="4">
                    <svg class="menuTop__icon">
            ...
            <div class="menuMinority">
                <div class="menuMinority__title" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });">
                    <svg class="menuMinority__arrow">
                        <use xlink:href="/res/_fs/image/13_symbols/action.svg#dropdown"></use>
                    </svg>
                    <div class="menuMinority__text" data-text-long="Các môn khác" data-text-short="Khác">
                    </div>
                </div>
                <div class="menuMinority__content" data-mobile-headline="Các môn khác">
                    <a href="/bandy/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="10">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#bandy"></use>
                        </svg>
                        <div class="menuMinority__text">Bandy</div>
                    </a>
                    <a href="/bong-chuyen-bai-bien/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="17">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#beach-volleyball"></use>
                        </svg>
                        <div class="menuMinority__text">B.Chuyền Bãi biển</div>
                    </a>
                    <a href="/bida-snooker/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="15">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#snooker"></use>
                        </svg>
                        <div class="menuMinority__text">Bida snooker</div>
                    </a>
                    <a href="/bong-ban/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="25">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#table-tennis"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng bàn</div>
                    </a>
                    <a href="/bong-bau-duc-my/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="5">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#american-football"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng bầu dục Mỹ</div>
                    </a>
                    <a href="/bong-bau-duc-uc/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="18">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#aussie-rules"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng bầu dục Úc</div>
                    </a>
                    <a href="/bong-chay/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="6">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#baseball"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng chày</div>
                    </a>
                    <a href="/bong-chuyen/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="12">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#volleyball"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng chuyền</div>
                    </a>
                    <a href="/bong-da/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="1">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#soccer"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng đá</div>
                    </a>
                    <a href="/bong-da-bai-bien/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="26">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#beach-soccer"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng đá bãi biển</div>
                    </a>
                    <a href="/bong-nem/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="7">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#handball"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng ném</div>
                    </a>
                    <a href="/bong-nuoc/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="22">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#water-polo"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng nước</div>
                    </a>
                    <a href="/bong-ro/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="3">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#basketball"></use>
                        </svg>
                        <div class="menuMinority__text">Bóng rổ</div>
                    </a>
                    <a href="/cau-long/" class="menuMinority__item--active menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="21">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#badminton"></use>
                        </svg>
                        <div class="menuMinority__text">Cầu lông</div>
                    </a>
                    <a href="/cricket/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="13">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#cricket"></use>
                        </svg>
                        <div class="menuMinority__text">Cricket</div>
                    </a>
                    <a href="/dua-ngua/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="35">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#horse-racing"></use>
                        </svg>
                        <div class="menuMinority__text">Đua ngựa</div>
                    </a>
                    <a href="/dua-xe/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="31">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#motorsport"></use>
                        </svg>
                        <div class="menuMinority__text">Đua xe</div>
                    </a>
                    <a href="/dua-xe-dap/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="34">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#cycling"></use>
                        </svg>
                        <div class="menuMinority__text">Đua xe đạp</div>
                    </a>
                    <a href="/floorball/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="9">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#floorball"></use>
                        </svg>
                        <div class="menuMinority__text">Floorball</div>
                    </a>
                    <a href="/futsal/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="11">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#futsal"></use>
                        </svg>
                        <div class="menuMinority__text">Futsal</div>
                    </a>
                    <a href="/golf/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="23">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#golf"></use>
                        </svg>
                        <div class="menuMinority__text">Golf</div>
                    </a>
                    <a href="/hockey/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="4">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#hockey"></use>
                        </svg>
                        <div class="menuMinority__text">Hockey</div>
                    </a>
                    <a href="/hockey-tren-co/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="24">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#field-hockey"></use>
                        </svg>
                        <div class="menuMinority__text">Hockey trên cỏ</div>
                    </a>
                    <a href="/kabaddi/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="42">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#kabaddi"></use>
                        </svg>
                        <div class="menuMinority__text">Kabaddi</div>
                    </a>
                    <a href="/netball/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="29">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#netball"></use>
                        </svg>
                        <div class="menuMinority__text">Netball</div>
                    </a>
                    <a href="/pesapallo/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="30">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#pesapallo"></use>
                        </svg>
                        <div class="menuMinority__text">Pesäpallo</div>
                    </a>
                    <a href="/phi-tieu/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="14">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#darts"></use>
                        </svg>
                        <div class="menuMinority__text">Phi tiêu</div>
                    </a>
                    <a href="/quyen-anh/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="16">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#boxing"></use>
                        </svg>
                        <div class="menuMinority__text">Quyền Anh</div>
                    </a>
                    <a href="/rugby-league/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="19">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#rugby-league"></use>
                        </svg>
                        <div class="menuMinority__text">Rugby League</div>
                    </a>
                    <a href="/rugby-union/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="8">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#rugby-union"></use>
                        </svg>
                        <div class="menuMinority__text">Rugby Union</div>
                    </a>
                    <a href="/tennis/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="2">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#tennis"></use>
                        </svg>
                        <div class="menuMinority__text">Tennis</div>
                    </a>
                    <a href="/the-thao-dien-tu/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="36">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#esports"></use>
                        </svg>
                        <div class="menuMinority__text">Thể thao điện tử</div>
                    </a>
                    <a href="/the-thao-mua-dong/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="37">
                        <svg class="menuMinority__icon">
                            <use xlink:href="/res/_fs/image/13_symbols/sport.svg#winter-sports"></use>
                        </svg>
                        <div class="menuMinority__text">T.Thao Mùa đông</div>
                    </a>
                    <a href="/mma/" class="menuMinority__item" onclick="cjs.Api.loader.get('sportMenu').call(function(sportMenu) { sportMenu.toggleMinority() });" data-sport-id="28">
                        <svg class="menuMinority__icon">
                                            ...
                                            <div class="">
                                                <div class="event__header">
                                                    ...
                                                    <div class="icon--flag event__title fl_3473162">
                                                        <div class="event__titleBox"><span class="event__title--type">BWF WORLD TOUR - NAM</span><span class="event__title--name" title="HYLO Mở rộng (Đức)">HYLO Mở rộng (Đức)</span>
                                                        </div>
                                                        <div class="wizard__relativeWrapper">
                                                            <button type="button" class="eventSubscriber eventSubscriber__pin" title="Ghim giải đấu này vào mục Giải đấu được ghim!">
                                                                <svg class="pin-ico pin eventPin">
                                                                    <title></title>
                                                                    <use xlink:href="/res/_fs/build/action.30f034d.svg#pin"></use>
                                                                </svg>
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <a href="#" class="event__info active">Nhánh đấu</a><span class="event__expanderBlock" title="Ẩn tất cả trận đấu thuộc giải đấu!"><svg class="arrow event__expander event__expander--open">
                                                            <title></title>
                                                            <use xlink:href="/res/_fs/build/action.30f034d.svg#arrow"></use>
                                                        </svg></span>
                                                </div>
                                                <div id="g_21_6JpNiGCL" title="Click để có thông tin trận đấu!" elementtiming="SpeedCurveFRP" class="event__match event__match--scheduled event__match--twoLine">
                                                    <div class="eventSubscriber eventSubscriber__star eventSubscriber__star--event" title="Thêm trận đấu này vào mục Quan tâm!">
                                                        <svg class="star-ico eventStar">
                                                            <title></title>
                                                            <use xlink:href="/res/_fs/build/action.30f034d.svg#star"></use>
                                                        </svg>
                                                    ...
                                                    <span class="flag fl_222 event__logo event__logo--away" title="Hồng Kông"></span>
                        ...
                        <div class="container__overlay">
                            ...
                            <div class="mbox0px l-brd">
                                <div class="menu country-list leftMenu leftMenu--active" id="mt">
                                    ...
                                    <div class="leftMenu__item leftMenu__item--width " title="BWF World Tour HYLO Mở rộng Men"><a class="leftMenu__href" href="/cau-long/bwf-world-tour-men/hylo-open/">
                                            <svg class="leftMenu__icon leftMenu__icon--rank">
                                                <use xlink:href="/res/_fs/image/13_symbols/others.svg#man"></use>
                                            </svg>
                ...
                <aside id="extraContent" class="extraContent">
                    <div class="extraContent__content">
                        <div class="extraContent__text"><b>Hỗ trợ:</b> Dịch vụ kết quả cầu lông của Flashscore.vn cung cấp
                            ...
                            theo dõi kết quả cầu lông từ tất cả các giải đấu cầu lông đang diễn ra tại trang web này, <a href="/cau-long/xep-hang/bwf-singles-men/">xếp hạng BWF thế giới</a>, giải đấu (ví dụ <a href="/cau-long/bwf-world-tour-men/all-england-open/">All England Mở rộng</a>, <a href="/cau-long/bwf-world-tour-men/japan-open/">Nhật Bản Mở rộng</a>, <a href="/cau-long/bwf-world-tour-men/indonesia-open/">Indonesia Mở rộng</a>) hay trang hồ sơ
                            của các vận động viên (<a href="/cau-thu/axelsen-viktor/2TL9oyiB/">Viktor Axelsen</a>, <a href="/cau-thu/yamaguchi-akane/pKuBkeNb/">Akane Yamaguchi</a>, … )!<br>
                            Theo dõi tỉ số trực tiếp HYLO mở rộng 2023 tại Flashscore.vn! HYLO mở rộng 2023 <a href="/cau-long/bwf-world-tour-men/hylo-open/">đơn nam</a>, <a href="/cau-long/bwf-world-tour-women/hylo-open/">đơn nữ</a>, <a href="/cau-long/bwf-world-tour-doubles-men/hylo-open/">đôi nam</a>, <a href="/cau-long/bwf-world-tour-doubles-women/hylo-open/">đôi nữ</a>.
                        </div>
                    </div>
                ...
                <div class="seoFooter__mainGroup">
                    <div class="seoFooter__categories">
                        <div class="seoFooter__category">
                            <div class="seoFooter__categoryTitle"><a href="https://www.flashscore.vn/">BÓNG ĐÁ</a></div>
                            <div class="seoFooter__categoryLinks">
                                <div>
                                    <a href="https://www.flashscore.vn/bong-da/asia/afc-champions-league/">AFC Champions
                                        League 2023</a>
                                </div>
                                <div>
                                </div>
                            ...
                            <div class="seoFooter__category">
                                <div class="seoFooter__categoryTitle"><a href="https://www.flashscore.vn/tennis/">TENNIS</a>
                                </div>
                                <div class="seoFooter__categoryLinks">
                                    <a href="https://www.flashscore.vn/tennis/xep-hang/wta/">Bảng xếp hạng WTA Đơn</a>
                                </div>
                            </div>
                        </div>
                        <div class="seoFooter__category">
                            <div class="seoFooter__categoryTitle"><a href="https://www.flashscore.vn/live-scores/">THỂ THAO
                                    THÊM</a></div>
                            <div class="seoFooter__categoryLinks">
                                <div>
                                    <a href="https://www.flashscore.vn/bong-bau-duc-my/usa/nfl/#/dd6l0LmE/table/overall">NFL
                                        - trực tiếp</a>
                                </div>
                            </div>
                        </div>
                        <div class="seoFooter__category">
                            <div class="seoFooter__categoryTitle"><a href="https://www.flashscore.vn/live-scores/">ĐANG
                                    THỊNH HÀNH</a></div>
                            <div class="seoFooter__categoryLinks">
                                <div>
                                    <a href="https://www.flashscore.vn/cau-thu/nguyen-thuy-linh/zi9Vvtp8/">Thùy Linh
                                        Nguyễn</a>
                                </div>
                                <div>
                                    <a href="https://www.flashscore.vn/bong-ro/usa/nba/#/4CS5kbsl/table/overall">NBA
                                        2023</a>
                                </div>
                                <div>
                                    <a href="https://www.flashscore.vn/bong-chay/usa/mlb/">MLB 2023</a>
                                </div>
                                <div>
                                    <a href="https://www.flashscore.vn/cau-long/xep-hang/bwf-singles-men/">BWF Đơn Nam</a>
                                </div>
                                <div>
                                    <a href="https://www.flashscore.vn/cau-long/xep-hang/bwf-singles-women/">BWF Đơn Nữ</a>
                                </div>
                            </div>
                        </div>
                        <div class="seoFooter__category">
                            <div class="seoFooter__categoryTitle"><a href="https://www.flashscore.vn/bong-da/england/premier-league/#/I3O5jpB2/table/overall">NGOẠI
                                    HẠNG ANH 2023</a></div>
                            <div class="seoFooter__categoryLinks">
                                <div>
                                    <a href="https://www.flashscore.vn/h2h/bong-da/tottenham-UDg08Ohm/chelsea-4fGZN2oK/#/overall">Tottenham
                                        - Chelsea</a>
                                </div>
                            </div>
                        </div>
