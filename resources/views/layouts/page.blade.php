...
<head>
    ...
    <script src="{{'/homepage/js/datetimepicker.min.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/content/js/vendors/bootstrap/bootstrap.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/js/dataTables.min.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/content/js/vendors/toastr/toastr.min.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/js/sweetalert2.min.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/js/lazyIntroCroppiePaceTippy.min.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/js/photoswipe.min.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/content/system/theme/assets/global/plugins/moment.min.js'}}" type="text/javascript"></script>
    <script src="{{'/homepage/content/system/theme/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js'}}" type="text/javascript"></script>
