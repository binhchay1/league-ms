                            ...
                            <div class="d-flex align-items-start bg-success bg-opacity-10 p-3 rounded">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center mb-1">
                                        <!-- Avatar -->
                                        <img src="{{ asset($leagueInfor->user->profile_photo_path ?? asset('/images/default-avatar.png')) }}"
                                            alt="avatar" class="rounded-circle me-2" width="50" height="50">
                                        <span><strong>{{ $leagueInfor->user->name }}</strong>
                                            {{ 'created tournament.' }}</span>
                                    </div>

                                    <!-- Thời gian + thiết bị -->
                                    <p class="text-green">
                                        {{ \Carbon\Carbon::parse($leagueInfor->created_at)->diffForHumans() }}</p>
                                </div>
                            </div>
                        </div>
