            ...
            <div id="fullpage">
                    ...
                    <div class="ps-wrapper">
                        <div class="site-logo">
                            <a href="/" title="Hệ thống quản lý giải đấu">
                                <img alt="Hệ thống quản lý giải đấu" width="220"
                                     src="homepage/content/images/white_logo.jpg"/>
                            </a>
                        </div>
                        <div class="ps-middle">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="st-image">
                            <img alt="Tạo giải và điều hành giải đấu"
                                 src="homepage/asset/home-page/images/index/home-2-image.png"/>
                        </div>
                        <div class="st-steps">
                                    ...
                                    <div class="ps-post">
                                        <div class="ps-post__thumb">
                                            <img alt="Loại trực tiếp"
                                                 src="homepage/asset/home-page/images/index/home-3-image1.png?id=123"/>
                                        </div>
                                        <div class="ps-post__content">
                                            <img width="100" alt="Loại trực tiếp"
                                                 src="homepage/content/images/icon_elimination.svg?id=123"
                                    ...
                                    <div class="ps-post">
                                        <div class="ps-post__thumb">
                                            <img alt="Đấu vòng tròn"
                                                 src="homepage/asset/home-page/images/index/home-3-image2.png?id=123"/>
                                        </div>
                                        <div class="ps-post__content">
                                    ...
                                    <div class="ps-post">
                                        <div class="ps-post__thumb">
                                            <img alt="Chia bảng đấu"
                                                 src="homepage/asset/home-page/images/index/home3-image5.png?id=123"/>
                                        </div>
                                        <div class="ps-post__content">
                                            <img alt="Chia bảng đấu"
                                                 src="homepage/content/images/icon_two_stages.svg?id=123"
                                    ...
                                    <div class="ps-post">
                                        <div class="ps-post__thumb">
                                            <img alt="Nhánh thắng - nhánh thua"
                                                 src="homepage/asset/home-page/images/index/home-3-image3.png?id=123"/>
                                        </div>
                                        <div class="ps-post__content">
                                            <img alt="Nhánh thắng - nhánh thua" style="padding:10px"
                                                 src="homepage/content/images/icon_two_elimination.svg?id=123"
                                    ...
                                    <div class="ps-post">
                                        <div class="ps-post__thumb">
                                            <img alt="Vòng tròn - loại trực tiếp"
                                                 src="homepage/asset/home-page/images/index/home-3-image4.png?id=123"/>
                                        </div>
                                        <div class="ps-post__content">
                                            <img alt="Vòng tròn - loại trực tiếp" style="padding:10px"
                                                 src="homepage/content/images/icon_league_knockout.svg?id=123"
                ...
                <div class="section" id="home--4">
                    <div class="ps-banner left">
                        <img alt="Phần mềm tạo giải đấu"
                             src="homepage/asset/home-page/images/index/home4-img-left.svg"/>
                    </div>
                    <div class="container">
                                ...
                                <div class="col-xs-12 col-lg-3 static-column" data-aos="zoom-out-right"
                                    ...
                                    <div class="static-item">
                                        <img
                                            ...
                                            src="homepage/asset/home-page/images/index/home-4-icon1.svg"/>
                                        <h4>Thời gian</h4>
                                        <p>
                                ...
                                <div class="col-xs-12 col-lg-3 static-column" data-aos="zoom-out-right"
                                    ...
                                    <div class="static-item">
                                        <img
                                            ...
                                            src="homepage/asset/home-page/images/index/home-4-icon2.svg"/>
                                        <h4>Sự tiện lợi</h4>
                                        <p>
                                ...
                                <div class="col-xs-12 col-lg-3 static-column" data-aos="zoom-out-left"
                                    ...
                                    <div class="static-item">
                                        <img
                                            ...
                                            src="homepage/asset/home-page/images/index/home-4-icon3.svg"/>
                                ...
                                <div class="col-xs-12 col-lg-3 static-column" data-aos="zoom-out-left"
                                    ...
                                    <div class="static-item">
                                        <img
                                            ...
                                            src="homepage/asset/home-page/images/index/home-4-icon4.svg"/>
                    ...
                    <div class="ps-banner right">
                        <img alt="Nền tảng quản lý giải đấu, đội thi đấu"
                             src="homepage/asset/home-page/images/index/home4-img-right.png"/>
                    </div>
                </div>
