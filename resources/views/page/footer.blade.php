                ...
                <div id="infoSite" class="col-sm-4 col-sm-pull-4">
                    <div class="help-block small">
                        ...
                        <ul class="footer-menu">
                            ...
                            <br/>
                            <li class="policyProfile"><a href="https://myleague.vn/policy-profile" class> Chính sách
                                    bảo mật thông tin cá nhân </a></li>
                            <br/>
                            <li><a href="" class> Nhận xét về MyLeague </a></li>
                            <li><a href="" class> Bảng giá </a></li>
                            <br>
                            <li class="wrap-social-myleague">
                                <ul class="social-myleague">
                                    ...
                                    <li><a target="_blank" href="https://instagram.com/myleague.vn"><i
