                            ...
                            @if($league->status == 1)
                                <div class="col-lg-4 mt-2">
                                    <div class="" style="background-color: #eff2f4; padding: 5px; margin-bottom: 15px;">
                                        ...
                                        <a href="{{ route('schedule.leagueSchedule', $league['slug']) }}" style="margin-bottom: 10px;width: 70%;margin-left: 55px;" class="btn btn-primary col-sm-12 mt-4 ">{{__('Create Schedule')}}</a>
                                    </div>
                                </div>
                            @endif
                        @empty
