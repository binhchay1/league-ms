...
@section('content')
    <div class="container-fluid mt-4">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form id="formAccountSettings" method="POST" action="{{ route('group.update', $dataGroup['id']) }}" enctype="multipart/form-data">
                    @csrf()
                    ...
                    <div class="row">
                        ...
                        <div class="container ml-4">
                            ...
                            <div class="mt-4">
                                ...
                                <select class="form-control" name="status" id="status" value="{{ $dataGroup->status }}">
