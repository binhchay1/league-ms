...
<div class="container-fluid mt-4">
    <div class="card card-default">
        ...
        <div class="card-body">
            <form id="formAccountSettings" method="POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
                @csrf()
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <input class="form-control" value="{{ old('title') }}" type="text" name="title" id="name" placeholder="{{ __('Enter post title') }}"/>
                                @if ($errors->has('title'))
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                      <input type="radio" id="html" name="status" value="hot">
                                      <label for="html">{{__('Hot')}}</label><br>
                                      <input type="radio" id="css" name="status" value="popular">
                                      <label for="css">{{__('Popular')}}</label><br>
                                      <input type="radio" id="javascript" name="status" value="normal">
