...
@section('content')
    <div class="container-fluid mt-4">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form id="formAccountSettings" method="POST" action="{{ route('categoryPost.update',$categoryPost['id'] ) }}" enctype="multipart/form-data">
                    @csrf()
                    <div class="row">
                        <div class="col-md-10">
                            <div class="row mt-4">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" value="{{$categoryPost->name}}" type="text" name="name" id="name" />
                                    @if ($errors->has('name'))
