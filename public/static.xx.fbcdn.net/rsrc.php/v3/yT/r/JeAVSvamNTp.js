...
(function(a) {
    ...
    function t(a) {
        ...
        while (a.length) {
            ...
            if (!f || U(f)) continue;
            if (f.dependencies)
                for (c = 0; c < f.dependencies.length; c++) g = f.dependencies[c], U(g) || a.push(g.id)
        }
    ...
    function Q() {
        ...
        Object.keys(d).length > 0 && T.apply(null, [
            ["FBLogger"],
            function(a) {
        ...
        if (d.length > 0) {
            ...
            l(function() {
                if (v) {
                    ...
                    while (p.length > 0) D.call(null, p.pop().id)
            })()
        }
        return n
    }
...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "BootloaderRetryTracker", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "CSSLoaderConfig", "ClientConsistency", "ErrorPubSub", "ExecutionEnvironment", "FBLogger", "JSResourceReferenceImpl", "MakeHasteTranslations", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "SiteData", "TimeSlice", "TrustedTypesBootloaderDataURIScriptURLPolicy", "TrustedTypesMetaURIScriptURLPolicy", "__debug", "clearTimeout", "cr:696703", "err", "fb-error", "ifRequireable", "ifRequired", "nullthrows", "performanceAbsoluteNow", "performanceNow", "promiseDone", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g, h) {
    ...
    function N(a, b, d) {
        ...
        c("nullthrows")(self.bl_worker_import_wrapper)(f).then(function() {
            ...
            F.maybeScheduleRetry(f, function() {
                ...
                t.set(a, i), c("FBLogger")("bootloader").catching(h).warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", a, f, i - e, F.getNumRetriesForSource(f), r.size - s.size), c("NetworkStatus").reportError(), d()
            })
        })
    }
    ...
    function P(a, b, d, e) {
        ...
        a.onerror = h.bind(void 0, function() {
            ...
            F.maybeScheduleRetry(f, function() {
                ...
                t.set(b, h), c("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", b, f, h - g, F.getNumRetriesForSource(f), r.size - s.size), c("NetworkStatus").reportError(), e()
            })
        })
    }
    ...
    function ea(a, b, e, f) {
        ...
        if ((b.type === "js" || b.type === "css") && b.p != null && b.d !== 1 && c("BootloaderConfig").hypStep4) {
            ...
            if (i.size === g.length) return;
            else i.size > 0 && (b.src = S(b.src, i), b.type === "js" && b.tsrc != null && b.tsrc.trim() !== "" && (b.tsrc = S(c("nullthrows")(b.tsrc), i)))
        }
    ...
    function ha(a, b, d, f) {
        ...
        T((i == null ? void 0 : i.r) || [], {
            ...
            onAll: function() {
                return E.registerCallback(function() {
                    E.notify(E.tierTwoStart(a)), e.call(null, l.map(c("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
        ...
        T((j == null ? void 0 : j.r) || [], {
            ...
            onAll: function() {
                return E.registerCallback(function() {
                    E.notify(E.tierThreeStart(a)), e.call(null, m.map(c("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
    ...
    function X(a) {
        ...
        g || window._btldr && window._btldr[e] ? f() : b.type === "js" ? P(a, e, b, f) : c("CSSLoader").setupEventListeners(e, b.src, L(), f, Q(e, b, f), c("CSSLoaderConfig").forcePollForBootloader === !0 ? null : a)
    }
    ...
    var $ = {
        loadModules: function(a, b, f) {
            ...
            E.registerCallback(e.bind(null, g, function() {
                o && (o.callbackStart = (k || (k = c("performanceAbsoluteNow")))()), j.apply(void 0, arguments), o && (o.callbackEnd = (k || (k = c("performanceAbsoluteNow")))()), E.notify(n)
            }), g.map(function(a) {
                if (c("BootloaderConfig").earlyRequireLazy) return ca(a);
                else return E.tierOne(a)
            }).filter(Boolean));
            M(function(b) {
        ...
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            s.set(a, (k || (k = c("performanceAbsoluteNow")))()), E.notify(E.rsrcDone(a))
        },
        ...
        notifyManuallyLoadedResources: function(a) {
            for (var b in a) {
                ...
                var e = a[b];
                (e.type === "js" || e.type === "css") && (w.has(b) && !c("BootloaderConfig").silentDups && c("FBLogger")("bootloader").warn("Duplicate manual resource [%s]: %s", b, e.src), U(b, e, !0), e.type === "js" && e.tsrc != null && e.tsrc.trim() !== "" && c("promiseDone")(d("MakeHasteTranslations").genFetchAndProcessTranslations(b, c("nullthrows")(e.tsrc))), r.set(b, (k || (k = c("performanceAbsoluteNow")))()), $.done(b))
            }
        },
    ...
    var h, i = new Set((h || (h = c("InitialCookieConsent"))).initialConsent),
        ...
        k = {
            ...
            isThirdPartyIframeAllowed: function(a) {
                if (!k.isFirstPartyStorageAllowed()) return !1;
...
__d("getAsyncParams", ["CSRBitMap", "CometPersistQueryParams", "CurrentAdAccount", "CurrentBusinessUser", "CurrentCommunity", "CurrentUserInitialData", "DTSG", "DTSGUtils", "DTSG_ASYNC", "Env", "ISB", "JSErrorLoggingConfig", "LSD", "ServerJSDefine", "SiteData", "SprinkleConfig", "StaticSiteData", "WebConnectionClassServerGuess", "WebSession", "asyncParams", "getAsyncParamsFromCurrentPageURI", "isSocialPlugin", "requireWeak", "uniqueRequestID"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
        ...
        (i || (i = c("Env"))).isCQuick && !f.cquick && (f.cquick = (i || (i = c("Env"))).iframeKey, f.ctarget = i.iframeTarget, f.cquick_token = i.iframeToken);
        if (a == "POST") {
        ...
        if (c("SiteData").spin) {
            f[(e = c("StaticSiteData")).spin_rev_key] = c("SiteData")[e.spin_rev_key];
            f[e.spin_branch_key] = c("SiteData")[e.spin_branch_key];
            f[e.spin_time_key] = c("SiteData")[e.spin_time_key];
            c("SiteData")[c("StaticSiteData").spin_mhenv_key] && (f[c("StaticSiteData").spin_mhenv_key] = c("SiteData")[c("StaticSiteData").spin_mhenv_key])
        }
...
__d("hyperionCore", ["Promise", "__debug", "hyperionHook"], (function(a, b, c, d, e, f, g) {
    ...
    function c(a) {
        var b;
        k.getCallStack = (b = a.getCallStack) != null ? b : k.getCallStack;
        k.logger = a.logger
    }
    ...
    function l(a, b, c) {
        if (!a) {
            a = (a = c == null ? void 0 : c.getCallStack) != null ? a : k.getCallStack;
            c = (c = c == null ? void 0 : c.logger) != null ? c : k.logger;
            a = a(2);
    ...
    function r(a, b, c) {
        ...
        for (var e = 0, f = d.length; e < f; ++e) {
            ...
            if (!(g in b)) {
                ...
                l(h != null, "Unexpected situation, we should have own property for " + g);
                try {
    ...
    function B(a, b) {
        if (z(a) && !A(a)) {
            b = b;
            for (var c = 0; !b && c < v.length; ++c) b = v[c](a);
            b || (b = a[t]);
            if (b) {
                c = {
    ...
    function E(a, b, c) {
        a = C(a, !0);
        a ? a.virtualPropertyValues[b] = c : l(!!a, "Could not get extension for the object");
        return c
    }
    var F = "__ext",
        G = function() {},
        ...
        H = function(b) {
            ...
            function a(a, c, d) {
                ...
                J(a.interceptor, babelHelpers.assertThisInitialized(a));
                a.implementation = c;
            ...
            c.updateDispatcherFunc = function() {
                var b = 0;
                b |= this.onArgsMapper ? 8 : 0;
                b |= this.onArgsObserver ? 4 : 0;
                b |= this.onValueMapper ? 2 : 0;
                b |= this.onValueObserver ? 1 : 0;
                b |= this.onArgsAndValueMapper ? 16 : 0;
                var c = a.dispatcherCtors[b];
                l(!!c, "unhandled interceptor state " + b);
                this.dispatcherFunc = c(this)
            };
            c.onArgsMapperAdd = function(a) {
                this.onArgsMapper || (this.onArgsMapper = new aa(), this.updateDispatcherFunc());
                return this.onArgsMapper.add(a)
            };
            c.onArgsMapperRemove = function(a) {
                var b;
                ((b = this.onArgsMapper) == null ? void 0 : b.remove(a)) && this.updateDispatcherFunc();
                return a
            };
            c.onArgsObserverAdd = function(a) {
                this.onArgsObserver || (this.onArgsObserver = new ba(), this.updateDispatcherFunc());
                return this.onArgsObserver.add(a)
            };
            c.onArgsObserverRemove = function(a) {
                var b;
                ((b = this.onArgsObserver) == null ? void 0 : b.remove(a)) && this.updateDispatcherFunc();
                return a
            };
            c.onValueMapperAdd = function(a) {
                this.onValueMapper || (this.onValueMapper = new ca(), this.updateDispatcherFunc());
                return this.onValueMapper.add(a)
            };
            c.onValueMapperRemove = function(a) {
                var b;
                ((b = this.onValueMapper) == null ? void 0 : b.remove(a)) && this.updateDispatcherFunc();
                return a
            };
            c.onValueObserverAdd = function(a) {
                this.onValueObserver || (this.onValueObserver = new da(), this.updateDispatcherFunc());
                return this.onValueObserver.add(a)
            };
            c.onValueObserverRemove = function(a) {
                var b;
                ((b = this.onValueObserver) == null ? void 0 : b.remove(a)) && this.updateDispatcherFunc();
                return a
            };
            c.onArgsAndValueMapperAdd = function(a) {
                this.onArgsAndValueMapper || (this.onArgsAndValueMapper = new ea(), this.updateDispatcherFunc());
                return this.onArgsAndValueMapper.add(a)
            };
            c.onArgsAndValueMapperRemove = function(a) {
                var b;
                ((b = this.onArgsAndValueMapper) == null ? void 0 : b.remove(a)) && this.updateDispatcherFunc();
                return a
            };
    ...
    H.dispatcherCtors = function() {
        ...
        a = (a = {}, a[0] = function(a) {
            ...
            return function() {
                ...
                a.onValueObserver.call.call(this, b);
                return b
            }
        }, a[2] = function(a) {
            return function() {
                var b;
                b = a.implementation.apply(this, arguments);
                b = a.onValueMapper.call.call(this, b);
                return b
            }
        }, a[3] = function(a) {
            return function() {
            ...
            return function() {
                var b;
                a.onArgsObserver.call.apply(this, arguments) || (b = a.implementation.apply(this, arguments));
                return b
            }
        }, a[5] = function(a) {
            return function() {
                var b;
                a.onArgsObserver.call.apply(this, arguments) || (b = a.implementation.apply(this, arguments), a.onValueObserver.call.call(this, b));
                return b
            }
        }, a[6] = function(a) {
            return function() {
                var b;
                a.onArgsObserver.call.apply(this, arguments) || (b = a.implementation.apply(this, arguments), b = a.onValueMapper.call.call(this, b));
                return b
            }
        }, a[7] = function(a) {
            return function() {
                var b;
                a.onArgsObserver.call.apply(this, arguments) || (b = a.implementation.apply(this, arguments), b = a.onValueMapper.call.call(this, b), a.onValueObserver.call.call(this, b));
                return b
            }
        }, a[8] = function(a) {
            return function() {
                var b, c = a.onArgsMapper.call.call(this, arguments);
            ...
            return function() {
                var b, c = a.onArgsMapper.call.call(this, arguments);
                a.onArgsObserver.call.apply(this, c) || (b = a.implementation.apply(this, c));
                return b
            }
        }, a[13] = function(a) {
            return function() {
                var b, c = a.onArgsMapper.call.call(this, arguments);
                a.onArgsObserver.call.apply(this, c) || (b = a.implementation.apply(this, c), a.onValueObserver.call.call(this, b));
                return b
            }
        }, a[14] = function(a) {
            return function() {
                var b, c = a.onArgsMapper.call.call(this, arguments);
                a.onArgsObserver.call.apply(this, c) || (b = a.implementation.apply(this, c), b = a.onValueMapper.call.call(this, b));
                return b
            }
        }, a[15] = function(a) {
            return function() {
                var b, c = a.onArgsMapper.call.call(this, arguments);
                a.onArgsObserver.call.apply(this, c) || (b = a.implementation.apply(this, c), b = a.onValueMapper.call.call(this, b), a.onValueObserver.call.call(this, b));
                return b
            }
        }, a[16] = function(a) {
            return function() {
                var b, c = a.onArgsAndValueMapper.call.call(this, arguments);
                b = a.implementation.apply(this, arguments);
                b = c.call(this, b);
                return b
            }
            ...
            return function() {
                var b;
                if (!a.onArgsObserver.call.apply(this, arguments)) {
                    var c = a.onArgsAndValueMapper.call.call(this, arguments);
                    b = a.implementation.apply(this, arguments);
                    b = c.call(this, b)
                }
                return b
            ...
            return function() {
                var b, c = a.onArgsMapper.call.call(this, arguments),
                    d = a.onArgsAndValueMapper.call.call(this, arguments);
                b = a.implementation.apply(this, c);
                b = d.call(this, b);
                return b
            }
            ...
            return function() {
                var b, c = a.onArgsMapper.call.call(this, arguments);
                if (!a.onArgsObserver.call.apply(this, c)) {
                    var d = a.onArgsAndValueMapper.call.call(this, arguments);
                    b = a.implementation.apply(this, c);
                    b = d.call(this, b)
                }
                return b
    ...
    function K(a, b, c, d) {
        ...
        l(typeof a === "function", "cannot intercept non-function input");
        var e = I(a);
        e || (e = c ? new c(d, a, b) : new H(d, a, b));
        return e
    }
    var L = function(b) {
        babelHelpers.inheritsLoose(a, b);
    ...
    function M(a, b) {
        ...
        if (b) {
            ...
            if (!c) {
                var d = I(b.get),
                    e = I(b.set);
                l(!(d && e) || d === e, "Getter/Setter of method " + a + " have differnt interceptors");
                c = (a = d) != null ? a : e
            }
            b.interceptor = c
        }
    ...
    function N(a, b, c, d) {
        ...
        c === void 0 && (c = !1);
        var f = M(a, b);
        return (e = f == null ? void 0 : f.interceptor) != null ? e : new((e = d) != null ? e : L)(a, b, c, f)
    }
    ...
    function ia(a, b) {
        var c, d = M(a, b);
        return (c = d == null ? void 0 : d.interceptor) != null ? c : new ha(a, b, d)
    }
    ...
    var Q = function() {
            function a(a, b) {
                this.onBeforInterceptObj = new((j || (j = d("hyperionHook"))).Hook)();
                this.onAfterInterceptObj = new j.Hook();
        ...
        S = function() {
            if (typeof __webpack_module_cache__ === "object") return new ja(__webpack_module_cache__);
            else if (typeof b === "function") try {
                var a = b("__debug");
                if (typeof a === "object") return new ka(a)
            } catch (a) {}
            return new R()
        }();
    ...
    var la = Object.freeze({
            __proto__: null,
            interceptModuleExports: T,
            validateModuleInterceptor: U
        }),
        V = Object.getPrototypeOf((i || (i = b("Promise"))).resolve());
    h = (h = w(V)) != null ? h : x(V, new Q(V, null));
    V = N("then", h);
    var W = N("catch", h),
        ma = Object.freeze({
            __proto__: null,
    ...
    w = (w = w(a)) != null ? w : new Q(a, null);
    var X = N("setInterval", w);
    w = N("setTimeout", w);
    ...
    function oa(a, b) {
        ...
        if (b) {
            ...
            d = d == null ? void 0 : d.getData(Y);
            l(!(c && d) || c === d, "Getter/Setter of attribute " + a + " have differnt interceptors");
    ...
    g.IGlobalThis = na;
    g.IPromise = ma;
    g.IPromisePrototype = h;
    g.IRequire = la;
    g.ShadowPrototype = Q;
    g.assert = l;
    g.getFunctionInterceptor = I;
    g.getLogger = e;
    g.getObjectExtension = C;
    g.getVirtualPropertyValue = D;
    g.global = a;
    g.intercept = B;
    g.interceptAttribute = pa;
    g.interceptAttributeBase = $;
    g.interceptConstructor = ga;
    g.interceptConstructorMethod = ia;
    g.interceptFunction = K;
    g.interceptMethod = N;
    g.interceptModuleExports = T;
    g.registerShadowPrototype = x;
    g.registerShadowPrototypeGetter = f;
    g.setAssertLoggerOptions = c;
    g.setInterval = X;
    g.setTimeout = w;
    g.setVirtualPropertyValue = E;
    g.then = V;
    g.validateModuleInterceptor = U
}), 98);
...
__d("CookieStore", ["CookieCoreLoggingConfig", "FBLogger", "Random", "gkx", "performanceNow"], (function(a, b, c, d, e, f, g) {
    ...
    function a() {
        return c("gkx")("676837") ? new q() : new o()
    }
    g.newCookieStore = a;
    ...
    a = function() {
        ...
        b.$20 = function() {
            ...
            if (b.length === 0) {
                ...
                return
            }(i || (i = c("WebStorage"))).setItemGuarded(a, this.$11, d("FBJSON").stringify({
...
__d("FalcoLoggerInternal", ["AnalyticsCoreData", "BaseEventEmitter", "FBLogger", "FalcoConsentChecker", "FalcoUtils", "ODS", "PersistedQueue", "Promise", "Random", "ServerTime", "nullthrows", "performanceAbsoluteNow"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i, j, k, l = d("FalcoUtils").getTaggedBitmap(33),
        m = 500 * 1024 * .6,
        n = "ods_web_batch",
        o = new Map(),
        p = new Set(["cmcd_messenger_web_logging_event", "javascript_web_error", "comet_redblock"]);

    function q(a) {
        var b;
        a.tags = d("FalcoUtils").xorBitmap((b = a.tags) != null ? b : [0, 0], l);
        return a
    }
    ...
    function a(a, b) {
        ...
        for (var d = d, e = Array.isArray(d), f = 0, d = e ? d : d[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
            ...
            var i = a + "^$" + h;
            if (o.has(i)) continue;
            g = ((g = (k || (k = c("AnalyticsCoreData"))).use_falco_as_mutex_key) != null ? g : !1) ? c("PersistedQueue").create(a, {
                onLoad: q,
                queueNameSuffix: h,
                application: "falco"
    ...
    f = d("FalcoUtils").identityToString((k || (k = c("AnalyticsCoreData"))).identity);
    var r = a("falco_queue_log", f),
        s = a("falco_queue_immediately", f),
        t = a("falco_queue_critical", f),
        u = new(c("BaseEventEmitter"))(),
        v = new(c("BaseEventEmitter"))();

    function w(a, b) {
        (i || (i = d("ODS"))).bumpEntityKey(1344, "falco.fabric.www." + (k || (k = c("AnalyticsCoreData"))).push_phase, a, b)
    }

    function x(a, b, e, f) {
        if (a === n) return;
        (i || (i = d("ODS"))).bumpEntityKey(1344, "falco.event." + a + "." + (k || (k = c("AnalyticsCoreData"))).push_phase, b, e);
        f && w(b, e)
    }
    var y = {};
    ...
    function z(a, b) {
        ...
        b = b.c;
        b != null && (k || (k = c("AnalyticsCoreData"))).consents != null && (d = d && A(b, (k || (k = c("AnalyticsCoreData"))).consents, a));
        return d
    }

    function A(a, b, d) {
        var e = y[a];
        e == null && (e = y[a] = JSON.parse(a));
    ...
    function C(a, b, d, e, f, g) {
        D(a, b, d, e, f, g);
        if ((k || (k = c("AnalyticsCoreData"))).enable_observer) {
    ...
    function D(a, b, d, e, f, g) {
        if ((k || (k = c("AnalyticsCoreData"))).enable_cmcd_observer && !p.has(a)) {
            a = babelHelpers["extends"]({
                name: a,
                time: b,
                sampled: d,
    ...
    function E(a, b, d, e, f, g) {
        f = JSON.stringify(f);
        if (f.length > m) {
            x(a, "js.drop.oversized_message", 1, !0);
            c("FBLogger")("falco", "oversized_message:" + a).warn('Dropping event "%s" due to exceeding the max size %s at %s', a, m, f.length);
            return
        }
        ...
        x(a, "js.event.write_to_queue", 1, !0)
    }
    ...
    function G(a, c, d, e, f) {
        try {
            ...
            if (i) {
                var j = e(),
                    k = (h || (h = b("Promise"))).resolve(d && d());
                return h.all([j, k]).then(function(b) {
                    var d = b[0],
                        e = b[1];
                    E(a, c, g, e, d, f);
                    C(a, g, i, c, function() {
...
__d("SidebarPrelude", ["Arbiter", "Bootloader", "CSS", "ChatConfig", "URI", "setTimeout"], (function(a, b, c, d, e, f, g) {
    var h, i = d("ChatConfig").get("sidebar.hide_buddylist_off_homepage"),
        j = d("ChatConfig").get("sidebar.hide_buddylist_off_allpage"),
        k = "buddylistOff",
        l = "sidebarMode";
    ...
    function a(a) {
        ...
        if (b) {
            var e = j || i && !m();
            e ? d("CSS").addClass(b, k) : (d("CSS").removeClass(b, k), i && c("setTimeout")(function() {
                c("Bootloader").loadModules(["Dock"], function(a) {
                    a.resizeAllFlyouts()
                }, "SidebarPrelude")
            }));
            b.clientWidth > a && (d("CSS").addClass(b, l), c("Arbiter").inform("sidebar/visibility", !0, "state"))
        }
    }
    ...
    function b() {
        ...
        if (a) {
            var b = j || i && !m();
            b ? d("CSS").addClass(a, k) : (d("CSS").removeClass(a, k), i && c("setTimeout")(function() {
                c("Bootloader").loadModules(["Dock"], function(a) {
                    a.resizeAllFlyouts()
                }, "SidebarPrelude")
            }))
    ...
    function m() {
        return new(h || (h = c("URI")))(window.location.href).getPath() === "/"
    }
    g.addSidebarMode = a;
