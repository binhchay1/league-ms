...
__d("CacheStorage", ["ErrorGuard", "EventListenerImplForCacheStorage", "ExecutionEnvironment", "FBJSON", "WebStorage", "emptyFunction", "err", "killswitch"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, b) {
            ...
            b && (!p[b] || !p[b].available() ? ((i || (i = c("ExecutionEnvironment"))).canUseDOM, this._backend = new o()) : this._backend = new p[b]());
            a = this.useBrowserStorage();
            a && c("EventListenerImplForCacheStorage").listen(window, "storage", this._onBrowserValueChanged.bind(this));
            b = a ? this._backend.getStore().getItem(m) : this._backend.getStore()[m];
            b !== l && (c("killswitch")("CACHE_STORAGE_MODULE_CLEAR_OWN_KEYS") ? this.clear() : this.clearOwnKeys())
        }
        var b = a.prototype;
        ...
        function a(a) {
            ...
            this.$12 = function(a, c, e) {
                ...
                f ? d("MqttEnv").Env.scheduleCallback(function() {
                    ...
                    i(b.$11, new(d("MqttTypes").ConnectFailure)(a, e != null ? e : -1), c)
                })
            };
            this.$13 = function(a) {
                var c = b.$6;
...
__d("MqttUserName", ["gkx"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a(a, b, d, e, f, g, h, i, j, k, l) {
            h === void 0 && (h = null), i === void 0 && (i = ""), j === void 0 && (j = "websocket"), k === void 0 && (k = null), l === void 0 && (l = null), this.$1 = a, this.$2 = b, this.$3 = d, this.$4 = e, this.$5 = f, this.$6 = g, this.$7 = c("gkx")("1166607") ? !1 : typeof document === "object" && document && document.hasFocus && document.hasFocus(), this.$8 = h, this.$9 = i, this.$10 = j, this.$11 = k, this.$12 = l
        }
        var b = a.prototype;
...
__d("MqttConnection", ["MqttConnectionHookCollection", "MqttEnv", "MqttProtocolClient", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "Promise", "err"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.$28 = function() {
            ...
            g = c("MqttUtils").endpointWithExtraParameter(g, "cid", this.$6.getDeviceId());
            try {
        ...
        e.$33 = function(a, b, c, e) {
            if (this.$7 != null) try {
                ...
                b = f != null ? f : "null";
                this.$10.debugTrace("_doPublish", "publish " + a + " with messageId:" + b + " qos:" + c);
                this.$27.onPublish(a);
...
__d("isFastRefreshEnabledForCurrentDomain", ["justknobx"], (function(a, b, c, d, e, f, g) {
    "use strict";
...
__d("MqttChannel", ["ChannelClientID", "IrisSubscribeChecker", "MqttAnalyticsHook", "MqttConnection", "MqttEnv", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "Promise", "Run", "err", "isFastRefreshEnabledForCurrentDomain", "promiseDone", "requireDeferred"], (function(a, b, c, d, e, f, g) {
    "use strict";
    var h, i = 29125;
    a = function() {
        function a(a) {
        ...
        e.$24 = function() {
            ...
            d("Run").onUnload(function() {
                a.$10.onWindowUnload(), a.$25(d("MqttTypes").MqttErrors.BROWSER_CLOSE)
            })
        };
        e.shutdown = function() {
        ...
        e.$26 = function(a, b, e) {
            ...
            var f;
            e.qos === 0 ? f = this.$27(a, b, e.listener) : f = this.$28(a, b, e);
        ...
        e.$30 = function(a) {
            a.attempt += 1, c("MqttUtils").promiseDone(this.$29(a.topic, a.payload, a.options.qos, a.options.listener, a.attempt, a.startTime), function() {
                a.ack.resolve()
            }, function(b) {
                a.ack.reject(b)
            })
        ...
        e.$32 = function(a) {
            var b = this;
            a.attempt += 1;
            c("MqttUtils").promiseDone(this.$29(a.topic, a.payload, a.options.qos, a.options.listener, a.attempt, a.startTime), function() {
                return b.$33(a)
            }, function(a) {})
        };
...
__d("MqttLogger", ["ChannelClientID", "FBLogger", "Log", "LogHistory", "MqttEnv", "MqttGlobalStreamCounter", "MqttUnifiedClientConnectFalcoEvent", "MqttUnifiedClientDisconnectFalcoEvent", "MqttUnifiedClientIncomingPublishFalcoEvent", "MqttUnifiedClientOutgoingPublishFalcoEvent", "MqttWsClientTypedLoggerLite", "NetworkStatus", "ODS", "Random", "gkx"], (function(a, b, c, d, e, f, g) {
    ...
    var h, i = "mqtt_client",
        j = 100,
        k = "WEBSOCKET",
        l = typeof window !== "undefined" ? window : self,
        m = null,
        n = {
    ...
    a = function() {
        ...
        function a() {
            this.$1 = d("LogHistory").getInstance(i), this.$2 = 0, this.$3 = c("gkx")("778292"), this.$4 = Date.now(), this.$5 = c("ChannelClientID").getID(), this.$7(), this.$6 = d("MqttGlobalStreamCounter").getInstance(), this.$6.isEnabled() || (this.$6 = null)
        }
        var b = a.prototype;
        b.setAppId = function(a) {
            this.$2 === 0 && (this.$2 = a)
        ...
        b.eventLogConnect = function(a) {
            ...
            var s = {
                ...
                ws_count: (m = this.$6) == null ? void 0 : m.getGlobalState().totalConnectionStreams.toString(),
        ...
        b.eventLogDisconnect = function(a) {
            ...
            var f = {
                ...
                ws_count: (e = this.$6) == null ? void 0 : e.getGlobalState().totalConnectionStreams.toString(),
                disconnect_count: a.toString()
            };
            this.$8(function() {
        ...
        b.eventLogOutgoingPublish = function(a) {
            ...
            var q = Date.now(),
                r = {
                    ...
                    total_duration: m != null ? (q - m).toString() : null,
                    error: i,
        ...
        b.logError = function(a, b) {
            ...
            d("MqttEnv").Env.scheduleLoggingCallback(function() {
                try {
                    c("FBLogger")(i).catching(a).mustfix(b)
                } catch (a) {}
            })
        };
        b.logErrorWarn = function(a, b) {
            ...
            d("MqttEnv").Env.scheduleLoggingCallback(function() {
                try {
                    c("FBLogger")(i).catching(a).warn(b)
                } catch (a) {}
            })
        };
        ...
        b.bumpCounter = function(a) {
            var b = this;
            if (!d("Random").coinflip(j)) return;
            d("MqttEnv").Env.scheduleLoggingCallback(function() {
                b.$2 !== 0 && (h || (h = d("ODS"))).bumpEntityKey(2966, "mqtt_ws_client", b.$2 + "." + a, j), (h || (h = d("ODS"))).bumpEntityKey(2966, "mqtt_ws_client", a, j)
            })
        };
        b.$9 = function(a, b, e) {
            var f = this;
            d("MqttEnv").Env.scheduleLoggingCallback(function() {
                ...
                a !== n.DISCONNECT && c("MqttWsClientTypedLoggerLite").log(b)
            })
        };
        b.$10 = function(a, b, e) {
        ...
        b.$11 = function() {
            return l.navigator && l.navigator.onLine !== void 0 ? l.navigator.onLine : !1
        };
        b.getBrowserConnectivity = function() {
        ...
        b.$7 = function() {
            var a = this;
            if (l.navigator && l.navigator.onLine !== void 0) {
                var b = function(b) {
                    b = b.online;
    ...
    var h, i = "mqtt:",
        j = {
            ...
            initialize: function() {
                ...
                }, j.genGk, null, null, null, j.configRead, j.configWrite)
            }
        };
    f.exports = j
}), 34);
__d("FBMqttChannel", ["MqttChannel", "MqttEnvInitializer", "MqttWebConfig"], (function(a, b, c, d, e, f, g) {
    "use strict";
    c("MqttEnvInitializer").initialize();
    b = new(c("MqttChannel"))({
        endpoint: (a = c("MqttWebConfig")).endpoint,
...
__d("DGWRequestStreamRef", ["CompactSerializerPolyfill", "DGWRequestStreamUtils", "DGWStream", "DGWStreamHandler", "InflightAmends", "Promise", "RequestStreamCloseReason", "RequestStreamCommonRequestStreamCommonTypes", "RequestStreamE2EClientLoggerEvent", "RequestStreamE2EClientLoggerMessageType", "RequestStreamE2ELogger", "RequestStreamE2ESampling", "RequestStreamSingleChannelSingleChannelRequestStreamSerializers", "RequestStreamSingleChannelSingleChannelRequestStreamTypes", "RequestStreamState", "RequestStreamTransport", "RtiWebRequestStreamClient", "StreamRetryState", "err", "gkx", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.start = function(a) {
            ...
            return this.$26(f).then(function() {
                ...
                if (g !== d("DGWStream").StreamError.ESTABLISHMENT_ERROR) {
                    ...
                    e.$15.onRetry();
                    var m = c("gkx")("6002") ? e.$15.getBackoffDelayMs() : k * Math.pow(l, e.$21);
        ...
        e.shouldTerminateOrRetry = function(a, e, f, g) {
            ...
            this.$25(a, k, !e);
            if (e) {
                var l = c("gkx")("6002") ? Math.max((f = g) != null ? f : 0, this.$15.getBackoffDelayMs()) : (a = g) != null ? a : j;
                this.$14 = !0;
                return new(h || (h = b("Promise")))(function(a) {
            ...
            return b("regeneratorRuntime").async(function(n) {
                while (1) switch (n.prev = n.next) {
                    case 0:
                        ...
                        h = this.$30();
                        this.$13 = h;
                        j = d("DGWRequestStreamUtils").convertHeaders(babelHelpers["extends"]({}, g.headers, this.$31()), g.body != null, this.$5);
                        n.next = 8;
                        return b("regeneratorRuntime").awrap(this.$20.establishStream(j, h, this.$7));
                    case 8:
                        this.$11 = n.sent;
                        n.next = 23;
                        break;
        ...
        e.$25 = function(a, b, e) {
            ...
            c("gkx")("574") && this.$19.rejectAll(c("err")("stream terminating: " + b));
        ...
        e.$23 = function() {
            var a = {};
            c("gkx")("1626") && (a.pending_amendments_size = this.$19.getSize().toString());
            return a
        };
        return a
    }();
...
__d("DGWUtils", ["Base64", "DGWConstants", "DGWCppBridge", "DGWLoggingContext", "Random", "URI", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    ...
    e = function() {
        ...
        a.constructConnectUrl = function(a) {
            ...
            var s = (b = {}, b[(e = d("DGWConstants")).HEADER_CONSTANTS.HEADER_APPID] = f, b[e.HEADER_CONSTANTS.HEADER_APPVERSION] = g, b[e.HEADER_CONSTANTS.HEADER_AUTHTYPE] = i, b[e.HEADER_CONSTANTS.HEADER_DGW_VERSION] = "" + k, b[e.HEADER_CONSTANTS.HEADER_UUID] = l, b[e.HEADER_CONSTANTS.HEADER_TARGET_TIER] = m, b);
            a !== void 0 && (s[d("DGWConstants").HEADER_CONSTANTS.HEADER_ESTABLISH_STREAM_FRAME_BASE64] = j(a));
            n !== void 0 && (s[d("DGWConstants").HEADER_CONSTANTS.HEADER_LOGGING_ID] = n);
            r !== void 0 && (s[d("DGWConstants").HEADER_CONSTANTS.HEADER_REGIONHINT] = r);
            Object.keys(o).forEach(function(a) {
                var b = d("DGWConstants").HEADER_CONSTANTS.APPHEADER_PREFIX + a;
                Object.prototype.hasOwnProperty.call(s, b) || (s[b] = o[a])
            });
            f = new(h || (h = c("URI")))(p);
            f.setQueryData(s);
            f.setPath(f.getPath() + "/" + q);
            f.toString().length > 2e3 && (delete s[d("DGWConstants").HEADER_CONSTANTS.HEADER_ESTABLISH_STREAM_FRAME_BASE64], f.setQueryData(s));
            return f.toString()
        };
        return a
    }();
    f = function() {
        ...
        e.processData = function() {
            ...
            var g = e + i,
                h = g + i,
                j = h + i;
            b = k.__DgwCodecDecode(c, b, e, g, h, j);
            this.free(c);
            ...
            c = k.HEAPU32.subarray(j / i, j / i + 1)[0];
            if (this.$1 == null) {
                this.free(f);
                return
            }
            ...
            j = k.HEAPU32.subarray(g / i, g / i + 1)[0];
            c = k.HEAPU32.subarray(e / i, e / i + 1)[0];
            var l = [];
            for (b = 0; b < j; ++b) {
                var m = k.__getDGWFramePtr(c, b);
                h = k.__getFrameType(m);
                switch (h) {
                    case d("DGWConstants").DgwFrameType.DgwFrameType_Drain:
                        g = function() {
                            var b = k.__getDrainReasonFromDrainFrame(m),
                    ...
                    case d("DGWConstants").DgwFrameType.DgwFrameType_StreamGroup_EstabStream:
                        e = function() {
                            var b = k.__getStreamIdFromStreamGroupFrame(m),
                                c = k.__getEncodedParamsFromEstablishStreamFrame(m),
                                d = new Uint8Array(k.HEAPU8.subarray(c, c + k.__getEncodedParamsSizeFromEstablishStreamFrame(m)));
                            a.free(c);
                            l.push(function() {
                                var c;
                    ...
                    case d("DGWConstants").DgwFrameType.DgwFrameType_StreamGroup_Data:
                        h = function() {
                            var b = k.__getStreamIdFromStreamGroupFrame(m),
                                c = k.__getDataFromGroupedStreamDataFrame(m),
                                d = new Uint8Array(k.HEAPU8.subarray(c, c + k.__getDataSizeFromGroupedStreamDataFrame(m)));
                            a.free(c);
                            var e = k.__getRequiresAckFromGroupedStreamDataFrame(m) ? k.__getAckIdFromGroupedStreamDataFrame(m) : null;
                            l.push(function() {
                                var c;
                    ...
                    case d("DGWConstants").DgwFrameType.DgwFrameType_StreamGroup_Ack:
                        g = function() {
                            var b = k.__getStreamIdFromStreamGroupFrame(m),
                                c = k.__getAckIdFromGroupedStreamAckFrame(m);
                            l.push(function() {
                                var d;
        ...
        e.encodeData = function(a, b, c, e) {
            ...
            if (f === -1) return null;
            var g = k.HEAPU8.subarray(f, f + a.length);
            for (var h = 0; h < g.length; ++h) g[h] = a[h];
            a = this.malloc(i * 2);
            h = a;
            var j = a + i;
            e = k.__DgwCodecEncodeStreamGroup_Data(e, f, g.length, b, c, h, j);
            this.free(f);
            ...
            b = k.HEAPU32.subarray(h / i, h / i + 1)[0];
            c = k.HEAPU32.subarray(j / i, j / i + 1)[0];
            f = new Uint8Array(k.HEAPU8.subarray(b, b + c));
            this.free(b);
            this.free(a);
            return f
        };
        e.encodeAck = function(a, b) {
            var c = this.malloc(i * 2);
            if (c === -1) return null;
            var e = c,
                f = c + i;
            b = k.__DgwCodecEncodeStreamGroup_Ack(b, a, e, f);
            if (b !== d("DGWConstants").DgwCodecReturnCode.DgwCodecReturnCode_Success) {
            ...
            a = k.HEAPU32.subarray(e / i, e / i + 1)[0];
            b = k.HEAPU32.subarray(f / i, f / i + 1)[0];
            e = new Uint8Array(k.HEAPU8.subarray(a, a + b));
            this.free(a);
            this.free(c);
            return e
        };
        e.encodeDrain = function(a) {
            var b = this.malloc(i * 2);
            if (b === -1) return null;
            var c = b,
                e = b + i;
            a = k.__DgwCodecEncodeDrain(a, c, e);
            ...
            f = k.HEAPU32.subarray(c / i, c / i + 1)[0];
            a = k.HEAPU32.subarray(e / i, e / i + 1)[0];
            c = new Uint8Array(k.HEAPU8.subarray(f, f + a));
            this.free(f);
            this.free(b);
            return c
        };
        e.encodeEstablishStream = function(a, b) {
            ...
            if (c === -1) return null;
            var e = k.HEAPU8.subarray(c, c + b.length);
            for (var f = 0; f < b.length; ++f) e[f] = b[f];
            e = this.malloc(i * 2);
            f = e;
            var g = e + i;
            b = k.__DgwCodecEncodeStreamGroup_EstabStream(a, c, b.length, f, g);
            this.free(c);
            if (b !== d("DGWConstants").DgwCodecReturnCode.DgwCodecReturnCode_Success) {
            ...
            c = k.HEAPU32.subarray(f / i, f / i + 1)[0];
            b = k.HEAPU32.subarray(g / i, g / i + 1)[0];
            a = new Uint8Array(k.HEAPU8.subarray(c, c + b));
            this.free(c);
            this.free(e);
            return a
        };
        e.encodeEndOfData = function(a) {
            ...
            var c = b,
                e = b + i;
            a = k.__DgwCodecEncodeStreamGroup_EndOfData(a, c, e);
            if (a !== d("DGWConstants").DgwCodecReturnCode.DgwCodecReturnCode_Success) {
                var f;
        ...
        e.encodePing = function() {
            ...
            var a = this.malloc(i * 2);
            if (a === -1) return null;
            var b = a,
                c = a + i,
                e = k.__DgwCodecEncodePing(b, c);
            if (e !== d("DGWConstants").DgwCodecReturnCode.DgwCodecReturnCode_Success) {
                var f;
            ...
            f = k.HEAPU32.subarray(b / i, b / i + 1)[0];
            e = k.HEAPU32.subarray(c / i, c / i + 1)[0];
            b = new Uint8Array(k.HEAPU8.subarray(f, f + e));
            this.free(f);
            this.free(a);
            this.$5 = b;
            return b
...
__d("DGWStreamFactory", ["DGWClient", "DGWStreamGroupHandler", "Promise", "gkx", "uuidv4"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        function a() {
            this.$3 = 0, this.$1 = null, c("gkx")("2819") && (this.$2 = c("uuidv4")())
        }
        a.get = function() {
            k == null && (k = new a());
            return k
        ...
        d.establishStream = function(a, d, e) {
            ...
            if (this.$1 == null || !this.$1.canCreateGroupedStream()) {
                ...
                c("gkx")("871") && (g.keepAliveMs = j);
                c("gkx")("2819") ? (this.$2 = c("uuidv4")(), g.loggingId = this.$2) : this.$2 = null;
                this.$3 = 0;
                try {
...
__d("MqttFetchClient", ["MqttEnv", "MqttProtocolCodec", "MqttUserName", "MqttUtils", "Promise", "PromiseResult"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        e.$26 = function(a, b, e) {
            ...
            g = c("MqttUtils").endpointWithExtraParameter(this.$1, m, o);
            ...
            c("MqttUtils").promiseDoneWithTimeout(u.fetch(g, {
                method: "POST",
                mode: "cors",
                cache: "no-cache",
                credentials: "include",
        ...
        e.$20 = function() {
            ...
            this.$10 = Date.now();
            var b = c("MqttUtils").endpointWithExtraParameter(this.$1, n, p);
            c("MqttUtils").promiseDoneWithTimeout(u.fetch(b, {
                method: "POST",
                mode: "cors",
                cache: "no-cache",
                credentials: "include",
