    ...
    $.extend(Timepicker.prototype, {
        ...
        _showTimepicker: function(input) {
            ...
            if ((!inst.inline) && (typeof $.ui.position == 'object')) {
                inst.tpDiv.position({ of: inst.input,
        ...
        _generateHTML: function(inst) {
            var h, m, row, col, html, hoursHtml, minutesHtml = '',
                ...
                showPeriodLabels = (this._get(inst, 'showPeriodLabels') == !0),
        ...
        _generateHTMLMinutes: function(inst) {
            var m, row, html = '',
                ...
                minutesPerRow = null,
                minuteCounter = 0,
                showMinutesLeadingZero = (this._get(inst, 'showMinutesLeadingZero') == !0),
        ...
        _generateHTMLHourCell: function(inst, hour, showPeriod, showLeadingZero) {
            ...
            if (enabled) {
                if (!isNaN(parseInt(maxTime.hour)) && hour > maxTime.hour) enabled = !1;
                if (!isNaN(parseInt(minTime.hour)) && hour < minTime.hour) enabled = !1
            }
            if (enabled) {
        ...
        _generateHTMLMinuteCell: function(inst, minute, displayText) {
            ...
            if (enabled && hour !== null) {
                if (!isNaN(parseInt(maxTime.hour)) && !isNaN(parseInt(maxTime.minute)) && hour >= maxTime.hour && minute > maxTime.minute) enabled = !1;
                if (!isNaN(parseInt(minTime.hour)) && !isNaN(parseInt(minTime.minute)) && hour <= minTime.hour && minute < minTime.minute) enabled = !1
            }
            if (enabled) {
