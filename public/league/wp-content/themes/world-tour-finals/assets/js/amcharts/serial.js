...
(function() {
    ...
    e.AmSerialChart = e.Class({
                ...
                if (0 < a.length) {
                    ...
                    for (c = 0; c < a.length; c++)
                        if (b = a[c], b.gridCountReal < d) {
                            var h = g = (d - b.gridCountReal) / 2,
                                f = g;
                            0 !== g - Math.round(g) && (h -= .5, f += .5);
                            b.minimum = b.min - h * b.step;
                            b.maximum = b.max + f * b.step;
                            b.setStep = b.step;
                            g = !0
                        }
                    g && this.updateAfterValueZoom();
                    for (c = 0; c < a.length; c++) b = a[c], b.minimum = NaN, b.maximum = NaN, b.setStep = NaN
                }
            }
        },
        ...
        showZB: function() {
            ...
            if (b = this.valueAxes) b = b[0], 0 !== e.roundTo(b.relativeStart, 3) && (a = !0), 1 != e.roundTo(b.relativeEnd, 3) && (a = !0);
            ...
            if (b) {
                ...
                for (var l = 0; l < c.length; l++) {
                    for (var k = c[l], m = 0, p = 0, n, r, w, y, u, q = 0, E = 0, v, t, x, B, A, G = this.start; G <= this.end; G++) {
                        var D = h[G];
                        if (D) {
                            var C = D.axes[g.id].graphs[b.id];
                            if (C) {
                                if (C.values) {
                                    var z = C.values[k],
                                        D = D.x.categoryAxis;
                                    if (this.rotate) {
                                        if (0 > D || D > C.graph.height) z = NaN
                                    } else if (0 > D || D > C.graph.width) z = NaN;
                                    if (!isNaN(z)) {
                                        isNaN(n) && (n = z);
                                        r = z;
                                        if (isNaN(w) || w > z) w = z;
                                        ...
                                        D = e.getDecimals(z);
                                        m += z;
                                        m = e.roundTo(m, Math.max(u, D));
                                        p++;
                                        u = m / p
                                    }
                                }
                                if (C.percents && (C = C.percents[k], !isNaN(C))) {
                                    isNaN(v) && (v = C);
                                    t = C;
                                    if (isNaN(x) || x > C) x = C;
                                    if (isNaN(B) || B < C) B = C;
                    ...
                    a = e.formatValue(a, q, d, this.pf, "percents\\." + k + "\\.")
                }
            }
...
(function() {
    var e = window.AmCharts;
    e.Cuboid = e.Class({
        construct: function(a, b, c, d, e, h, f, l, k, m, p, n, r, w, y, u, q) {
            this.set = a.set();
            this.container = a;
            this.h = Math.round(c);
            this.w = Math.round(b);
...
(function() {
    ...
    e.CategoryAxis = e.Class({
        ...
        draw: function() {
            ...
            if (e.ifArray(a)) {
                ...
                if (this.parseDates && !this.equalSpacing) this.lastTime = a[a.length - 1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * r), this.minPeriod, 1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw();
                    ...
                    if (this.cellWidth = this.getStepWidth(f), f < l && (l = f), h += this.start, this.stepWidth = this.getStepWidth(f), 0 < l)
                        for (v = Math.floor(f / l), r = this.chooseMinorFrequency(v), f = h, f / 2 == Math.round(f / 2) && f--, 0 > f && (f = 0), l = 0, this.widthField && (f = this.start), this.end - f + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = f; b <= this.end + 2; b++) {
                            p = !1;
                            ...
                            Math.round(l / g) != l / g && (n = void 0);
                            l++;
                            A = this.cellWidth;
                            E && (A = NaN, this.ignoreAxisWidth || !c.autoMargins) && (A = "right" == this.position ? c.marginRight : c.marginLeft, A -= this.tickLength + 10);
                    ...
                    y = g;
                    "WW" == y && (y = "DD");
                    this.currentDateFormat = this.dateFormatsObject[y];
                    ...
                    if (0 < this.gridCountR)
                        for (b = f; b < B; b++)
                            if (r = this.data[b].time, this.checkPeriodChange(g, w, r, n) && b >= A) {
                                ...
                                q = !1;
                                this.nextPeriod[y] && (q = this.checkPeriodChange(this.nextPeriod[y], 1, r, n, y)) && e.resetDateToMin(new Date(r), this.nextPeriod[y], 1, p).getTime() != r && (q = !1);
                                t = !1;
                                q && this.markPeriodChange ? (q = this.dateFormatsObject[this.nextPeriod[y]], t = !0) : q = this.dateFormatsObject[y];
            ...
            this.labelsSet.show();
            this.positionTitle();
            (E = this.axisLine.set) && E.toFront();
            var D = this.getBBox().height;
