    ...
    d.ValueAxis = d.Class({
        ...
        draw: function() {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                if (0 < B) {
                    D = this.fillAlpha;
                    for (g = this.fillAlpha = 0; g < B; g++) C = w[g], k = NaN, z = C.above, isNaN(C.toValue) || (k = this.getCoordinate(C.toValue), u = new this.axisItemRenderer(this, k, "", !0, NaN, NaN, C), this.pushAxisItem(u, z)), l = NaN, isNaN(C.value) || (l = this.getCoordinate(C.value), u = new this.axisItemRenderer(this, l, C.label, !0, NaN, (k - l) / 2, C), this.pushAxisItem(u, z)), isNaN(k) && (l -= 3, k = l + 3), isNaN(k - l) || 0 > l && 0 > k || (k = new this.guideFillRenderer(this, l, k, C), this.pushAxisItem(k, z), z = k.graphics(), C.graphics = z, C.balloonText && this.addEventListeners(z, C));
                    this.fillAlpha = D
                }
                g = this.baseValue;
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            if ("H" == Oa) {
                ...
                I = -3;
                "right" == Z && (I += ma);
                ca && (v > X + 1 || v < I) && (ca.remove(), ca = null)
            }
    ...
    d.AmGraph = d.Class({
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + y + "," + b[b.length - 1], n += " L" + y + "," + b[0]) : (n += " L" + a[a.length -
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.useGraphSettings) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) k = m.set(), a.hidden || (h = a.lineColorR, g = a.bulletBorderColorR), q = d.line(m, [0, 2 * n], [n / 2, n / 2], h, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, q, "graph-stroke"), k.push(q), a.bullet && (a.hidden || (h = a.bulletColorR), q = d.bullet(m, a.bullet, a.bulletSize, h, a.bulletAlpha, a.bulletBorderThickness, g, a.bulletBorderAlpha)) && (d.setCN(c, q, "graph-bullet"), q.translate(n + 1, n / 2), k.push(q)), t = 0, q = n, p = n / 3;
                    else {
                        var r;
                ...
                var y;
                h && (h = d.fixBrakes(h), a.legendTextReal = h, y = b.labelWidth, y = isNaN(y) ? d.text(b.container, h, g, c.fontFamily, r, "start") : d.wrappedText(b.container, h, g, c.fontFamily, r, "start", !1, y, 0), d.setCN(c, y, "legend-label"), y.translate(b.lx + q, b.ly), m.push(y), b.labelDx = q, c = y.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = m;
