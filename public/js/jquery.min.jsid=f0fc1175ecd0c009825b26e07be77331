...
!function(t, e) {
    ...
    v.extend = v.fn.extend = function() {
        ...
        r = arguments[a] || {},
        a++),
        "object" == _typeof(r) || v.isFunction(r) || (r = {}),
        a === l && (r = this,
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    i = r[e],
                    r !== (n = t[e]) && (h && n && (v.isPlainObject(n) || (s = v.isArray(n))) ? (s ? (s = !1,
                    o = i && v.isArray(i) ? i : []) : o = i && v.isPlainObject(i) ? i : {},
                    r[e] = v.extend(h, o, n)) : void 0 !== n && (r[e] = n));
        return r
    }
    ,
    v.extend({
        ...
        isPlainObject: function(t) {
            var e, i;
            return !(!t || "[object Object]" !== u.call(t) || (e = s(t)) && (i = c.call(e, "constructor") && e.constructor,
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (x(Object(t)) ? v.merge(i, "string" == typeof t ? [t] : t) : a.call(i, t)),
            i
        },
    ...
    var k = function(t) {
        var e, i, n, s, o, r, a, l, h, u, c, d, p, f, g, m, v, _, b, y = "sizzle" + 1 * new Date, w = t.document, x = 0, k = 0, C = rt(), D = rt(), T = rt(), I = function(t, e) {
            return t === e && (c = !0),
            0
        }, S = {}.hasOwnProperty, P = [], M = P.pop, A = P.push, N = P.push, E = P.slice, H = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, O = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", z = "[\\x20\\t\\r\\n\\f]", W = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", F = "\\[" + z + "*(" + W + ")(?:" + z + "*([*^$|!~]?=)" + z + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + W + "))|)" + z + "*\\]", L = ":(" + W + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", R = new RegExp(z + "+","g"), j = new RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$","g"), q = new RegExp("^" + z + "*," + z + "*"), B = new RegExp("^" + z + "*([>+~]|" + z + ")" + z + "*"), Y = new RegExp("=" + z + "*([^\\]'\"]*?)" + z + "*\\]","g"), $ = new RegExp(L), U = new RegExp("^" + W + "$"), K = {
            ID: new RegExp("^#(" + W + ")"),
            CLASS: new RegExp("^\\.(" + W + ")"),
            TAG: new RegExp("^(" + W + "|[*])"),
            ATTR: new RegExp("^" + F),
        ...
        }, V = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, Q = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + z + "?|(" + z + ")|.)","ig"), tt = function(t, e, i) {
            var n = "0x" + e - 65536;
        ...
        try {
            N.apply(P = E.call(w.childNodes), w.childNodes),
        ...
        function ot(t, e, n, s) {
            var o, a, h, u, c, f, v, _ = e && e.ownerDocument, x = e ? e.nodeType : 9;
            if (n = n || [],
            ...
            g)) {
                    ...
                    if (o = c[1]) {
                        if (9 === x) {
                            ...
                            if (h.id === o)
                                return n.push(h),
                                n
                        } else if (_ && (h = _.getElementById(o)) && b(e, h) && h.id === o)
                            return n.push(h),
                            n
                    } else {
                        if (c[2])
                            return N.apply(n, e.getElementsByTagName(t)),
                            n;
                        if ((o = c[3]) && i.getElementsByClassName && e.getElementsByClassName)
                            return N.apply(n, e.getElementsByClassName(o)),
                            n
                    }
                if (i.qsa && !T[t + " "] && (!m || !m.test(t))) {
                    if (1 !== x)
                        ...
                        for ((u = e.getAttribute("id")) ? u = u.replace(et, it) : e.setAttribute("id", u = y),
                        a = (f = r(t)).length; a--; )
                            f[a] = "#" + u + " " + vt(f[a]);
                        v = f.join(","),
                        _ = J.test(t) && gt(e.parentNode) || e
                    }
                    if (v)
                        try {
                            return N.apply(n, _.querySelectorAll(v)),
                            n
                        } catch (t) {} finally {
        ...
        d = ot.setDocument = function(t) {
            ...
            g = !o(p),
            w !== p && (s = p.defaultView) && s.top !== s && (s.addEventListener ? s.addEventListener("unload", nt, !1) : s.attachEvent && s.attachEvent("onunload", nt)),
            ...
            v = [],
            m = [],
            (i.qsa = G.test(p.querySelectorAll)) && (lt((function(t) {
                f.appendChild(t).innerHTML = "<a id='" + y + "'></a><select id='" + y + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && m.push("[*^$]=" + z + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || m.push("\\[" + z + "*(?:value|" + O + ")"),
                t.querySelectorAll("[id~=" + y + "-]").length || m.push("~="),
                t.querySelectorAll(":checked").length || m.push(":checked"),
                t.querySelectorAll("a#" + y + "+*").length || m.push(".#.+[+~]")
            }
            )),
            lt((function(t) {
                ...
                t.querySelectorAll("[name=d]").length && m.push("name" + z + "*[*^$|!~]?="),
        ...
        n = ot.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return K.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && $.test(i) && (e = r(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, i, n, s) {
                    ...
                    : function(e, i, l) {
                        var h, u, c, d, p, f, g = o !== r ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), _ = !l && !a, b = !1;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (d = e; d = d[g]; )
                            ...
                            r && _) {
                                for (b = (p = (h = (u = (c = (d = m)[y] || (d[y] = {}))[d.uniqueID] || (c[d.uniqueID] = {}))[t] || [])[0] === x && h[1]) && h[2],
                                d = p && m.childNodes[p]; d = ++p && d && d[g] || (b = p = 0) || f.pop(); )
                                    if (1 === d.nodeType && ++b && d === e) {
                                        u[t] = [x, p, b];
                                        break
                                    }
                            } else if (_ && (b = p = (h = (u = (c = (d = e)[y] || (d[y] = {}))[d.uniqueID] || (c[d.uniqueID] = {}))[t] || [])[0] === x && h[1]),
                            !1 === b)
                                for (; (d = ++p && d && d[g] || (b = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (_ && ((u = (c = d[y] || (d[y] = {}))[d.uniqueID] || (c[d.uniqueID] = {}))[t] = [x, b]),
                                d !== e)); )
                                    ;
        ...
        function _t(t, e, i) {
            ...
            : function(e, i, l) {
                ...
                if (l) {
                    ...
                    for (; e = e[n]; )
                        if (1 === e.nodeType || r)
                            if (u = (c = e[y] || (e[y] = {}))[e.uniqueID] || (c[e.uniqueID] = {}),
        ...
        function wt(t, e, i, n, s, o) {
            ...
            s && !s[y] && (s = wt(s, o)),
            at((function(o, r, a, l) {
                var h, u, c, d = [], p = [], f = r.length, g = o || function(t, e, i) {
                    for (var n = 0, s = e.length; n < s; n++)
                        ot(t, e[n], i);
                    return i
                }(e || "*", a.nodeType ? [a] : a, []), m = !t || !o && e ? g : yt(g, d, t, a, l), v = i ? s || (o ? t : f || n) ? [] : r : m;
                if (i && i(m, v, a, l),
                n)
                    for (h = yt(v, p),
                    n(h, [], a, l),
                ...
                if (o) {
                    if (s || t) {
                        ...
                        for (u = v.length; u--; )
                            (c = v[u]) && (h = s ? H(o, c) : d[u]) > -1 && (o[h] = !(r[h] = c))
                    }
                } else
                    v = yt(v === r ? v.splice(f, v.length) : v),
                    s ? s(null, r, v, l) : N.apply(r, v)
            }
            ))
        }
        function xt(t) {
        ...
        function kt(t, e) {
            var i = e.length > 0
              ...
              , o = function(o, r, a, l, u) {
                var c, f, m, v = 0, _ = "0", b = o && [], y = [], w = h, k = o || s && n.find.TAG("*", u), C = x += null == w ? 1 : Math.random() || .1, D = k.length;
                ...
                i && _ !== v) {
                    ...
                    if (o) {
                        if (v > 0)
                            for (; _--; )
                                b[_] || y[_] || (y[_] = M.call(l));
                        y = yt(y)
                    }
                    N.apply(l, y),
                    u && !o && y.length > 0 && v + e.length > 1 && ot.uniqueSort(l)
                }
                return u && (x = C,
                h = w),
                b
        ...
        r = ot.tokenize = function(t, e) {
            ...
            h = n.preFilter; a; ) {
                ...
                a = a.slice(i.length)),
                n.filter)
                    !(s = K[r].exec(a)) || h[r] && !(s = h[r](s)) || (i = s.shift(),
                    o.push({
                        value: i,
                        type: r,
                        matches: s
        ...
        l = ot.select = function(t, e, i, s) {
            var o, l, h, u, c, d = "function" == typeof t && t, p = !s && r(t = d.selector || t);
            if (i = i || [],
            1 === p.length) {
                if ((l = p[0] = p[0].slice(0)).length > 2 && "ID" === (h = l[0]).type && 9 === e.nodeType && g && n.relative[l[1].type]) {
                    if (!(e = (n.find.ID(h.matches[0].replace(Z, tt), e) || [])[0]))
                        return i;
                    d && (e = e.parentNode),
                    t = t.slice(l.shift().value.length)
                }
                for (o = K.needsContext.test(t) ? 0 : l.length; o-- && (h = l[o],
                !n.relative[u = h.type]); )
            ...
            return (d || a(t, p))(s, e, !g, i, !e || J.test(t) && gt(e.parentNode) || e),
            i
        }
        ,
        ...
        lt((function(t) {
            return t.innerHTML = "<a href='jquery.js#'></a>",
    ...
    v.uniqueSort = v.unique = k.uniqueSort,
    v.text = k.getText,
    v.isXMLDoc = k.isXML,
    v.contains = k.contains,
    v.escapeSelector = k.escape;
    ...
    function P(t, e, i) {
        ...
        )) : S.test(e) ? v.filter(e, t, i) : (e = v.filter(e, t),
        v.grep(t, (function(t) {
    ...
    v.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? v.find.matchesSelector(n, t) ? [n] : [] : v.find.matches(t, v.grep(e, (function(t) {
            return 1 === t.nodeType
        }
        )))
    }
    ...
    var M, A = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, N = v.fn.init = function(t, e, i) {
        var s, o;
        if (!t)
            return this;
        if (i = i || M,
        "string" == typeof t) {
            if (!(s = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : A.exec(t)) || !s[1] && e)
                return !e || e.jquery ? (e || i).find(t) : this.constructor(e).find(t);
            if (s[1]) {
                if (e = e instanceof v ? e[0] : e,
                v.merge(this, v.parseHTML(s[1], e && e.nodeType ? e.ownerDocument || e : n, !0)),
                I.test(s[1]) && v.isPlainObject(e))
                    for (s in e)
        ...
        this.length = 1,
        this) : v.isFunction(t) ? void 0 !== i.ready ? i.ready(t) : t(v) : v.makeArray(t, this)
    }
    ;
    N.prototype = v.fn,
    M = v(n);
    ...
    v.each({
        ...
        v.fn[t] = function(i, n) {
            ...
            this.length > 1 && (H[t] || v.uniqueSort(s),
            E.test(t) && s.reverse()),
            this.pushStack(s)
        }
    }
    ...
    v.extend({
              ...
              , s = {
                ...
                then: function(e, n, s) {
                            ...
                            var a = this
                              ...
                              , h = function() {
                                ...
                                if (!(e < o)) {
                                    ...
                                    h = t && ("object" == _typeof(t) || "function" == typeof t) && t.then,
                                    v.isFunction(h) ? s ? h.call(t, r(o, i, W, s), r(o, i, F, s)) : (o++,
                                    h.call(t, r(o, i, W, s), r(o, i, F, s), r(o, i, W, i.notifyWith))) : (n !== W && (a = void 0,
                                    l = [t]),
                                    (s || i.resolveWith)(a, l))
                                }
                            }
                    ...
                    return v.Deferred((function(t) {
                        i[0][3].add(r(0, t, v.isFunction(s) ? s : W, t.notifyWith)),
                        i[1][3].add(r(0, t, v.isFunction(e) ? e : W)),
                        i[2][3].add(r(0, t, v.isFunction(n) ? n : F))
                    }
                    )).promise()
                },
                promise: function(t) {
        ...
        when: function(t) {
            ...
            if (e <= 1 && (L(t, r.done(a(i)).resolve, r.reject),
            "pending" === r.state() || v.isFunction(s[i] && s[i].then)))
                return r.then();
            for (; i--; )
                L(s[i], a(i), r.reject);
            return r.promise()
    ...
    v.ready.then = j.then,
    "complete" === n.readyState || "loading" !== n.readyState && !n.documentElement.doScroll ? t.setTimeout(v.ready) : (n.addEventListener("DOMContentLoaded", q),
    ...
    var B = function t(e, i, n, s, o, r, a) {
        ...
        i))
            for (; l < h; l++)
                i(e[l], n, a ? s : s.call(e[l], l, i(e[l], n)));
    ...
    $.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== n) {
                if (void 0 !== e) {
                    v.isArray(e) ? e = e.map(v.camelCase) : e = (e = v.camelCase(e))in n ? [e] : e.match(z) || [],
                    i = e.length;
                    for (; i--; )
                        delete n[e[i]]
                }
    ...
    function G(t, e, i) {
        ...
        if (void 0 === i && 1 === t.nodeType)
            if (n = "data-" + e.replace(X, "-$&").toLowerCase(),
    ...
    v.extend({
        queue: function(t, e, i) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                n = U.get(t, e),
                i && (!n || v.isArray(i) ? n = U.access(t, e, v.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    v.fn.extend({
        queue: function(t, e) {
            ...
            t = "fx",
            i--),
            arguments.length < i ? v.queue(this[0], t) : void 0 === e ? this : this.each((function() {
        ...
        promise: function(t, e) {
            ...
            t = void 0),
            t = t || "fx"; r--; )
                (i = U.get(o[r], t + "queueHooks")) && i.empty && (n++,
                i.empty.add(a));
            return a(),
            s.promise(e)
        }
    ...
    function it(t, e, i, n) {
        ...
        , l = a(), h = i && i[3] || (v.cssNumber[e] ? "" : "px"), u = (v.cssNumber[e] || "px" !== h && +l) && J.exec(v.css(t, e));
        if (u && u[3] !== h) {
            h = h || u[3],
            i = i || [],
            u = +l || 1;
    ...
    var nt = {};
    function st(t) {
        var e, i = t.ownerDocument, n = t.nodeName, s = nt[n];
    ...
    function ot(t, e) {
        for (var i, n, s = [], o = 0, r = t.length; o < r; o++)
            ...
            e ? ("none" === i && (s[o] = U.get(n, "display") || null,
            s[o] || (n.style.display = "")),
            "" === n.style.display && tt(n) && (s[o] = st(n))) : "none" !== i && (s[o] = "none",
            U.set(n, "display", i)));
        for (o = 0; o < r; o++)
    ...
    function ut(t, e) {
        ...
        void 0 === e || e && v.nodeName(t, e) ? v.merge([t], i) : i
    }
    function ct(t, e) {
        for (var i = 0, n = t.length; i < n; i++)
    ...
    function pt(t, e, i, n, s) {
        for (var o, r, a, l, h, u, c = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
            if ((o = t[p]) || 0 === o)
                if ("object" === v.type(o))
                    ...
                    l = ht[a] || ht._default,
                    r.innerHTML = l[1] + v.htmlPrefilter(o) + l[2],
                    u = l[0]; u--; )
                        r = r.lastChild;
                    v.merge(d, r.childNodes),
        ...
        p = 0; o = d[p++]; )
            if (n && v.inArray(o, n) > -1)
                s && s.push(o);
            else if (h = v.contains(o.ownerDocument, o),
            r = ut(c.appendChild(o), "script"),
            h && ct(r),
            i)
                for (u = 0; o = r[u++]; )
                    lt.test(o.type || "") && i.push(o);
        return c
    }
    !function() {
        ...
        remove: function(t, e, i, n, s) {
            ...
            if (m && (l = m.events)) {
                for (h = (e = (e || "").match(z) || [""]).length; h--; )
                    if (p = g = (a = vt.exec(e[h]) || [])[1],
                    f = (a[2] || "").split(".").sort(),
                    p) {
                        for (c = v.event.special[p] || {},
                        d = l[p = (n ? c.delegateType : c.bindType) || p] || [],
                        a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        r = o = d.length; o--; )
                            u = d[o],
                            !s && g !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(o, 1),
                            u.selector && d.delegateCount--,
                            c.remove && c.remove.call(t, u));
                        r && !d.length && (c.teardown && !1 !== c.teardown.call(t, f, m.handle) || v.removeEvent(t, p, m.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            v.event.remove(t, p + e[h], i, n, !0);
                v.isEmptyObject(l) && U.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, i, n, s, o, r, a = v.event.fix(t), l = new Array(arguments.length), h = (U.get(this, "events") || {})[a.type] || [], u = v.event.special[a.type] || {};
            for (l[0] = a,
            e = 1; e < arguments.length; e++)
                l[e] = arguments[e];
            if (a.delegateTarget = this,
            !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (r = v.event.handlers.call(this, a, h),
                e = 0; (s = r[e++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (o = s.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = o.data,
                        void 0 !== (n = ((v.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && h.nodeType && !("click" === t.type && t.button >= 1))
                for (; h !== this; h = h.parentNode || this)
                    if (1 === h.nodeType && ("click" !== t.type || !0 !== h.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[s = (n = e[i]).selector + " "] && (r[s] = n.needsContext ? v(s, this).index(h) > -1 : v.find(s, this, null, [h]).length),
                            r[s] && o.push(n);
                        o.length && a.push({
                            elem: h,
                            handlers: o
    ...
    v.each({
        ...
        v.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return n && (n === this || v.contains(this, n)) || (t.type = s.origType,
    ...
    v.fn.extend({
        ...
        off: function(t, e, i) {
            ...
            if (t && t.preventDefault && t.handleObj)
                ...
                v(t.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace : n.origType, n.selector, n.handler),
                this;
            if ("object" == _typeof(t)) {
                for (s in t)
                    this.off(s, e, t[s]);
    ...
    function Nt(t, e, i, n) {
        e = r.apply([], e);
        var s, o, a, l, h, u, c = 0, d = t.length, p = d - 1, m = e[0], _ = v.isFunction(m);
        if (_ || d > 1 && "string" == typeof m && !f.checkClone && Ct.test(m))
            return t.each((function(s) {
                var o = t.eq(s);
                _ && (e[0] = m.call(this, s, o.html())),
                Nt(o, e, i, n)
            }
            ));
        if (d && (o = (s = pt(e, t[0].ownerDocument, !1, t, n)).firstChild,
        1 === s.childNodes.length && (s = o),
        o || n)) {
            for (l = (a = v.map(ut(s, "script"), St)).length; c < d; c++)
                h = s,
                c !== p && (h = v.clone(h, !0, !0),
                l && v.merge(a, ut(h, "script"))),
                i.call(t[c], h, c);
            if (l)
                ...
                c = 0; c < l; c++)
                    h = a[c],
                    lt.test(h.type || "") && !U.access(h, "globalEval") && v.contains(u, h) && (h.src ? v._evalUrl && v._evalUrl(h.src) : g(h.textContent.replace(Tt, ""), u))
        }
        return t
    }
    function Et(t, e, i) {
        for (var n, s = e ? v.filter(e, t) : t, o = 0; null != (n = s[o]); o++)
            ...
            n.parentNode && (i && v.contains(n.ownerDocument, n) && ct(ut(n, "script")),
    ...
    v.extend({
        ...
        clone: function(t, e, i) {
            var n, s, o, r, a = t.cloneNode(!0), l = v.contains(t.ownerDocument, t);
            if (!(f.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || v.isXMLDoc(t)))
                for (r = ut(a),
                n = 0,
                s = (o = ut(t)).length; n < s; n++)
                    At(o[n], r[n]);
            if (e)
                if (i)
                    for (o = o || ut(t),
                    ...
                    Mt(t, a);
            return (r = ut(a, "script")).length > 0 && ct(r, !l && ut(t, "script")),
            a
        },
        ...
        html: function(t) {
            return B(this, (function(t) {
                ...
                if ("string" == typeof t && !kt.test(t) && !ht[(at.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (e = this[i] || {}).nodeType && (v.cleanData(ut(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
    ...
    v.each({
        ...
        v.fn[t] = function(t) {
            for (var i, n = [], s = v(t), o = s.length - 1, r = 0; r <= o; r++)
    ...
    function Wt(t, e, i) {
        ...
        return (i = i || zt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || v.contains(t.ownerDocument, t) || (r = v.style(t, e)),
        !f.pixelMarginRight() && Ot.test(r) && Ht.test(e) && (n = a.width,
        s = a.minWidth,
        o = a.maxWidth,
    ...
    function Ut(t, e, i, n, s) {
        ...
        for (o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2)
            "margin" === i && (r += v.css(t, i + Z[o], !0, s)),
            n ? ("content" === i && (r -= v.css(t, "padding" + Z[o], !0, s)),
            "margin" !== i && (r -= v.css(t, "border" + Z[o] + "Width", !0, s))) : (r += v.css(t, "padding" + Z[o], !0, s),
            "padding" !== i && (r += v.css(t, "border" + Z[o] + "Width", !0, s)));
        return r
    }
    function Kt(t, e, i) {
        var n, s = !0, o = zt(t), r = "border-box" === v.css(t, "boxSizing", !1, o);
        if (t.getClientRects().length && (n = t.getBoundingClientRect()[e]),
        n <= 0 || null == n) {
            if (((n = Wt(t, e, o)) < 0 || null == n) && (n = t.style[e]),
            Ot.test(n))
                return n;
    ...
    v.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                return e = v.cssProps[a] || (v.cssProps[a] = Yt(a) || a),
                r = v.cssHooks[e] || v.cssHooks[a],
                void 0 === i ? r && "get"in r && void 0 !== (s = r.get(t, !1, n)) ? s : l[e] : ("string" === (o = _typeof(i)) && (s = J.exec(i)) && s[1] && (i = it(t, e, s),
                o = "number"),
                void (null != i && i == i && ("number" === o && (i += s && s[3] || (v.cssNumber[a] ? "" : "px")),
        ...
        css: function(t, e, i, n) {
            ...
            return e = v.cssProps[a] || (v.cssProps[a] = Yt(a) || a),
            (r = v.cssHooks[e] || v.cssHooks[a]) && "get"in r && (s = r.get(t, !0, i)),
            void 0 === s && (s = Wt(t, e, n)),
    ...
    v.each(["height", "width"], (function(t, e) {
        v.cssHooks[e] = {
            get: function(t, i, n) {
                if (i)
                    return !Lt.test(v.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Kt(t, e, n) : et(t, Rt, (function() {
                        return Kt(t, e, n)
                    }
                    ))
            },
            set: function(t, i, n) {
                var s, o = n && zt(t), r = n && Ut(t, e, n, "border-box" === v.css(t, "boxSizing", !1, o), o);
                return r && (s = J.exec(i)) && "px" !== (s[3] || "px") && (t.style[e] = i,
                i = v.css(t, e)),
                $t(0, i, r)
            }
        }
    ...
    v.cssHooks.marginLeft = Ft(f.reliableMarginLeft, (function(t, e) {
        if (e)
            return (parseFloat(Wt(t, "marginLeft")) || t.getBoundingClientRect().left - et(t, {
                marginLeft: 0
            }, (function() {
    ...
    v.fx.step = {};
    var Xt, Gt, Qt = /^(?:toggle|show|hide)$/, Jt = /queueHooks$/;
    function Zt() {
        Gt && (t.requestAnimationFrame(Zt),
        v.fx.tick())
    }
    function te() {
    ...
    function ne(t, e, i) {
        var n, s, o = 0, r = ne.prefilters.length, a = v.Deferred().always((function() {
            delete l.elem
        }
        )), l = function() {
            if (s)
                return !1;
            for (var e = Xt || te(), i = Math.max(0, h.startTime + h.duration - e), n = 1 - (i / h.duration || 0), o = 0, r = h.tweens.length; o < r; o++)
                h.tweens[o].run(n);
            return a.notifyWith(t, [h, n, i]),
            n < 1 && r ? i : (a.resolveWith(t, [h]),
            !1)
        }, h = a.promise({
            elem: t,
            props: v.extend({}, e),
        ...
        for (function(t, e) {
            ...
            if (n = ne.prefilters[o].call(h, t, u, h.opts))
                return v.isFunction(n.stop) && (v._queueHooks(h.elem, h.opts.queue).stop = v.proxy(n.stop, n)),
                n;
        return v.map(u, ie, h),
    ...
    v.Animation = v.extend(ne, {
        ...
        prefilters: [function(t, e, i) {
            var n, s, o, r, a, l, h, u, c = "width"in e || "height"in e, d = this, p = {}, f = t.style, g = t.nodeType && tt(t), m = U.get(t, "fxshow");
            for (n in i.queue || (null == (r = v._queueHooks(t, "fx")).unqueued && (r.unqueued = 0,
            a = r.empty.fire,
            ...
            d.always((function() {
                d.always((function() {
                    r.unqueued--,
                    v.queue(t, "fx").length || r.empty.fire()
                }
                ))
            }
            ))),
            ...
            if ((l = !v.isEmptyObject(e)) || !v.isEmptyObject(p))
                ...
                "none" === (u = v.css(t, "display")) && (h ? u = h : (ot([t], !0),
                h = t.style.display || h,
                u = v.css(t, "display"),
                ot([t]))),
                ("inline" === u || "inline-block" === u && null != h) && "none" === v.css(t, "float") && (l || (d.done((function() {
                    f.display = h
                }
                )),
                null == h && (u = f.display,
    ...
    v.fn.extend({
        ...
        finish: function(t) {
            return !1 !== t && (t = t || "fx"),
            this.each((function() {
                var e, i = U.get(this), n = i[t + "queue"], s = i[t + "queueHooks"], o = v.timers, r = n ? n.length : 0;
                for (i.finish = !0,
                v.queue(this, t, []),
    ...
    v.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? v.prop(t, e, i) : (1 === o && v.isXMLDoc(t) || (s = v.attrHooks[e.toLowerCase()] || (v.expr.match.bool.test(e) ? se : void 0)),
                void 0 !== i ? null === i ? void v.removeAttr(t, e) : s && "set"in s && void 0 !== (n = s.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : s && "get"in s && null !== (n = s.get(t, e)) ? n : null == (n = v.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    se = {
        set: function(t, e, i) {
            return !1 === e ? v.removeAttr(t, i) : t.setAttribute(i, i),
            i
        }
    },
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : v.isFunction(t) ? this.each((function(i) {
                ...
                if ("string" === i)
                    ...
                    void 0 !== t && "boolean" !== i || ((e = he(this)) && U.set(this, "__className__", e),
                    this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : U.get(this, "__className__") || ""))
            }
            ))
        },
        hasClass: function(t) {
            var e, i, n = 0;
            for (e = " " + t + " "; i = this[n++]; )
                if (1 === i.nodeType && (" " + le(he(i)) + " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    });
    ...
    v.fn.extend({
        val: function(t) {
            var e, i, n, s = this[0];
            return arguments.length ? (n = v.isFunction(t),
    ...
    v.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, o = v.makeArray(e), r = s.length; r--; )
                        ((n = s[r]).selected = v.inArray(v.valHooks.option.get(n), o) > -1) && (i = !0);
    ...
    v.extend(v.event, {
        trigger: function(e, i, s, o) {
            var r, a, l, h, u, d, p, f = [s || n], g = c.call(e, "type") ? e.type : e, m = c.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = l = s = s || n,
            3 !== s.nodeType && 8 !== s.nodeType && !ce.test(g + v.event.triggered) && (g.indexOf(".") > -1 && (m = g.split("."),
            g = m.shift(),
            m.sort()),
            u = g.indexOf(":") < 0 && "on" + g,
            (e = e[v.expando] ? e : new v.Event(g,"object" == _typeof(e) && e)).isTrigger = o ? 2 : 3,
            e.namespace = m.join("."),
            ...
            o || !p.trigger || !1 !== p.trigger.apply(s, i))) {
                if (!o && !p.noBubble && !v.isWindow(s)) {
                    for (h = p.delegateType || g,
                    ce.test(h + g) || (a = a.parentNode); a; a = a.parentNode)
                        f.push(a),
                        l = a;
                    l === (s.ownerDocument || n) && f.push(l.defaultView || l.parentWindow || t)
                }
                for (r = 0; (a = f[r++]) && !e.isPropagationStopped(); )
                    e.type = r > 1 ? h : p.bindType || g,
                    (d = (U.get(a, "events") || {})[e.type] && U.get(a, "handle")) && d.apply(a, i),
                    (d = u && a[u]) && d.apply && Y(a) && (e.result = d.apply(a, i),
                    !1 === e.result && e.preventDefault());
                return e.type = g,
                o || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(f.pop(), i) || !Y(s) || u && v.isFunction(s[g]) && !v.isWindow(s) && ((l = s[u]) && (s[u] = null),
                v.event.triggered = g,
                s[g](),
    ...
    v.fn.extend({
        ...
        triggerHandler: function(t, e) {
            var i = this[0];
            if (i)
                return v.event.trigger(t, e, i, !0)
        }
    }),
    ...
    f.focusin || v.each({
        ...
        v.event.special[e] = {
            ...
            teardown: function() {
                var n = this.ownerDocument || this
                  , s = U.access(n, e) - 1;
                s ? U.access(n, e, s) : (n.removeEventListener(t, i, !0),
                U.remove(n, e))
            }
        }
    }
    ...
    v.parseXML = function(e) {
        ...
        return i && !i.getElementsByTagName("parsererror").length || v.error("Invalid XML: " + e),
        i
    }
    ;
    var ge = /\[\]$/
    ...
    v.extend({
        ...
        ajax: function(e, i) {
            ...
            e = void 0),
            i = i || {};
            var s, o, r, a, l, h, u, c, d, p, f = v.ajaxSetup({}, i), g = f.context || f, m = f.context && (g.nodeType || g.jquery) ? v(g) : v.event, _ = v.Deferred(), b = v.Callbacks("once memory"), y = f.statusCode || {}, w = {}, x = {}, k = "canceled", C = {
                readyState: 0,
            ...
            if (_.promise(C),
            f.url = ((e || f.url || de.href) + "").replace(De, de.protocol + "//"),
            ...
            null == f.crossDomain) {
                ...
                try {
                    h.href = f.url,
                    h.href = h.href,
                    f.crossDomain = Pe.protocol + "//" + Pe.host != h.protocol + "//" + h.host
                } catch (t) {
                    f.crossDomain = !0
                }
            }
            ...
            u)
                return C;
            for (d in (c = v.event && f.global) && 0 == v.active++ && v.event.trigger("ajaxStart"),
            f.type = f.type.toUpperCase(),
            f.hasContent = !Ce.test(f.type),
            o = f.url.replace(we, ""),
            f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(ye, "+")) : (p = f.url.slice(o.length),
            f.data && (o += (fe.test(o) ? "&" : "?") + f.data,
            delete f.data),
            !1 === f.cache && (o = o.replace(xe, "$1"),
            p = (fe.test(o) ? "&" : "?") + "_=" + pe++ + p),
            f.url = o + p),
            f.ifModified && (v.lastModified[o] && C.setRequestHeader("If-Modified-Since", v.lastModified[o]),
            ...
            C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Se + "; q=0.01" : "") : f.accepts["*"]),
            f.headers)
            ...
            function D(e, i, n, a) {
                ...
                h ? (f.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (v.lastModified[o] = x),
                (x = C.getResponseHeader("etag")) && (v.etag[o] = x)),
                204 === e || "HEAD" === f.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = w.state,
                d = w.data,
                h = !(p = w.error))) : (p = k,
                !e && k || (k = "error",
                e < 0 && (e = 0))),
                C.status = e,
                C.statusText = (i || k) + "",
                h ? _.resolveWith(g, [d, k, C]) : _.rejectWith(g, [C, k, p]),
                C.statusCode(y),
                y = void 0,
                c && m.trigger(h ? "ajaxSuccess" : "ajaxError", [C, f, h ? d : p]),
                b.fireWith(g, [C, k]),
                ...
                send: function(s, o) {
                    ...
                    i = function(t) {
                        return function() {
                            ...
                            "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Ee[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
    ...
    v.ajaxPrefilter("json jsonp", (function(e, i, n) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            return s = e.jsonpCallback = v.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
            a ? e[a] = e[a].replace(ze, "$1" + s) : !1 !== e.jsonp && (e.url += (fe.test(e.url) ? "&" : "?") + e.jsonp + "=" + s),
            e.converters["script json"] = function() {
                return r || v.error(s + " was not called"),
                r[0]
            }
            ,
            e.dataTypes[0] = "json",
    ...
    v.parseHTML = function(t, e, i) {
        ...
        e = !1),
        e || (f.createHTMLDocument ? ((s = (e = n.implementation.createHTMLDocument("")).createElement("base")).href = n.location.href,
        e.head.appendChild(s)) : e = n),
        r = !i && [],
        (o = I.exec(t)) ? [e.createElement(o[1])] : (o = pt([t], e, r),
    ...
    v.fn.load = function(t, e, i) {
        ...
        return a > -1 && (n = le(t.slice(a)),
        t = t.slice(0, a)),
        v.isFunction(e) ? (i = e,
        e = void 0) : e && "object" == _typeof(e) && (s = "POST"),
        r.length > 0 && v.ajax({
            url: t,
            type: s || "GET",
            dataType: "html",
    ...
    v.offset = {
        setOffset: function(t, e, i) {
            var n, s, o, r, a, l, h = v.css(t, "position"), u = v(t), c = {};
            "static" === h && (t.style.position = "relative"),
            a = u.offset(),
            o = v.css(t, "top"),
            l = v.css(t, "left"),
            ("absolute" === h || "fixed" === h) && (o + l).indexOf("auto") > -1 ? (r = (n = u.position()).top,
            s = n.left) : (r = parseFloat(o) || 0,
            s = parseFloat(l) || 0),
            v.isFunction(e) && (e = e.call(t, i, v.extend({}, a))),
    ...
    v.fn.extend({
        offset: function(t) {
            ...
            return o ? o.getClientRects().length ? (n = o.getBoundingClientRect()).width || n.height ? (i = We(s = o.ownerDocument),
            e = s.documentElement,
            {
        ...
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === v.css(i, "position") ? e = i.getBoundingClientRect() : (t = this.offsetParent(),
                e = this.offset(),
        ...
        v.each({
            ...
            v.fn[n] = function(s, o) {
                ...
                return B(this, (function(e, i, s) {
                    var o;
                    return v.isWindow(e) ? 0 === n.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement,
                    Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === s ? v.css(e, i, a) : v.style(e, i, s, a)
                }
                ), e, r ? s : void 0, r)
            }
        }
...
function(t) {
    ...
    t.widget;
    !function() {
        var e, i = Math.max, n = Math.abs, s = /left|center|right/, o = /top|center|bottom/, r = /[\+\-]\d+(\.[\d]+)?%?/, a = /^\w+/, l = /%$/, h = t.fn.position;
        function u(t, e, i) {
        ...
        t.fn.position = function(e) {
            ...
            e = t.extend({}, e);
            var l, d, p, f, g, m, v, _, b = t(e.of), y = t.position.getWithinInfo(e.within), w = t.position.getScrollInfo(y), x = (e.collision || "flip").split(" "), k = {};
            ...
            g.top += l[1],
            this.each((function() {
                var s, o, r = t(this), a = r.outerWidth(), h = r.outerHeight(), m = c(this, "marginLeft"), v = c(this, "marginTop"), _ = a + m + c(this, "marginRight") + w.width, C = h + v + c(this, "marginBottom") + w.height, D = t.extend({}, g), T = u(k.my, r.outerWidth(), r.outerHeight());
                "right" === e.my[0] ? D.left -= a : "center" === e.my[0] && (D.left -= a / 2),
                "bottom" === e.my[1] ? D.top -= h : "center" === e.my[1] && (D.top -= h / 2),
                D.left += T[0],
                D.top += T[1],
                s = {
                    marginLeft: m,
                ...
                e.using && (o = function(t) {
                    ...
                    d < a && n(s + o) < d && (c.horizontal = "center"),
                    p < h && n(l + u) < p && (c.vertical = "middle"),
                    i(n(s), n(o)) > i(n(l), n(u)) ? c.important = "horizontal" : c.important = "vertical",
        ...
        t.ui.position = {
            fit: {
                left: function(t, e) {
                    var n, s = e.within, o = s.isWindow ? s.scrollLeft : s.offset.left, r = s.width, a = t.left - e.collisionPosition.marginLeft, l = o - a, h = a + e.collisionWidth - r - o;
                    e.collisionWidth > r ? l > 0 && h <= 0 ? (n = t.left + l + e.collisionWidth - r - o,
                    t.left += l - n) : t.left = h > 0 && l <= 0 ? o : l > h ? o + r - e.collisionWidth : o : l > 0 ? t.left += l : h > 0 ? t.left -= h : t.left = i(t.left - a, t.left)
                },
                top: function(t, e) {
                    var n, s = e.within, o = s.isWindow ? s.scrollTop : s.offset.top, r = e.within.height, a = t.top - e.collisionPosition.marginTop, l = o - a, h = a + e.collisionHeight - r - o;
                    e.collisionHeight > r ? l > 0 && h <= 0 ? (n = t.top + l + e.collisionHeight - r - o,
                    t.top += l - n) : t.top = h > 0 && l <= 0 ? o : l > h ? o + r - e.collisionHeight : o : l > 0 ? t.top += l : h > 0 ? t.top -= h : t.top = i(t.top - a, t.top)
                }
            },
            flip: {
                left: function(t, e) {
                    var i, s, o = e.within, r = o.offset.left + o.scrollLeft, a = o.width, l = o.isWindow ? o.scrollLeft : o.offset.left, h = t.left - e.collisionPosition.marginLeft, u = h - l, c = h + e.collisionWidth - a - l, d = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, f = -2 * e.offset[0];
                ...
                top: function(t, e) {
                    var i, s, o = e.within, r = o.offset.top + o.scrollTop, a = o.height, l = o.isWindow ? o.scrollTop : o.offset.top, h = t.top - e.collisionPosition.marginTop, u = h - l, c = h + e.collisionHeight - a - l, d = "top" === e.my[1], p = d ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, f = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, g = -2 * e.offset[1];
    ...
    var s, o, r = "ui-effects-", a = "ui-effects-style", l = "ui-effects-animated", h = t;
    t.effects = {
        effect: {}
    },
    function(t, e) {
        ...
        function d(e) {
            ...
            u(s, (function(t, i) {
                var s, o = i.re.exec(e), l = o && i.parse(o), h = i.space || "rgba";
                if (l)
                    return s = n[h](l),
                    n[r[h].cache] = s[r[h].cache],
                    a = n._rgba = s._rgba,
                    !1
            }
            )),
        ...
        o.fn = t.extend(o.prototype, {
            parse: function(n, s, a, l) {
                if (n === e)
                    ...
                    this;
                (n.jquery || n.nodeType) && (n = t(n).css(s),
                s = e);
                var h = this
                  , p = t.type(n)
                  , f = this._rgba = [];
                return s !== e && (n = [n, s, a, l],
                p = "array"),
                "string" === p ? this.parse(d(n) || i._default) : "array" === p ? (u(r.rgba.props, (function(t, e) {
                    f[e.idx] = c(n[e.idx], e)
                }
                )),
                ...
                : function(e, i) {
                    ...
                    h[s] && t.inArray(null, h[s].slice(0, 3)) < 0 && (h[s][3] = 1,
                    i.from && (h._rgba = i.from(h[s])))
                }
                ),
                this) : void 0
            },
        ...
        u(r, (function(i, s) {
            ...
            o.fn[i] = function(i) {
                ...
                i === e)
                    return this[a].slice();
                var n, s = t.type(i), d = "array" === s || "object" === s ? i : arguments, p = this[a].slice();
            ...
            u(r, (function(e, s) {
                o.fn[e] || (o.fn[e] = function(o) {
                    var r, a = t.type(o), l = "alpha" === e ? this._hsla ? "hsla" : "rgba" : i, h = this[l](), u = h[s.idx];
    ...
    function() {
        ...
        t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], (function(e, i) {
            t.fx.step[i] = function(t) {
                ("none" !== t.end && !t.setAttr || 1 === t.pos && !t.setAttr) && (h.style(t.elem, i, t.end),
                t.setAttr = !0)
            }
        }
        )),
        ...
        t.effects.animateClass = function(s, o, r, a) {
            ...
            return this.queue((function() {
                ...
                h = h.map((function() {
                    ...
                    this.diff = function(e, n) {
                        var s, o, r = {};
                        for (s in n)
                            o = n[s],
                            e[s] !== o && (i[s] || !t.fx.step[s] && isNaN(parseFloat(o)) || (r[s] = o));
                        return r
                    }(this.start, this.end),
                    this
                }
    ...
    function() {
        ...
        t.fn.extend({
            effect: function() {
                ...
                if (t.fx.off || !n)
                    return h ? this[h](i.duration, a) : this.each((function() {
                        a && a.call(this)
                    }
                    ));
                function d(e) {
                    ...
                    i.mode = u.shift(),
                    !1 === t.uiBackCompat || s ? "none" === i.mode ? (o[h](),
                    r()) : n.call(o[0], i, (function() {
                        o.removeData(l),
                        t.effects.cleanUp(o),
                        "hide" === i.mode && o.hide(),
                        r()
    ...
    t.effects.define("bounce", (function(e, i) {
        ...
        r.css("opacity", 0).css(m, v ? 2 * -c : 2 * c).animate(s, f, g)),
        l && (c /= Math.pow(2, d - 1)),
        (s = {})[m] = o; _ < d; _++)
            (n = {})[m] = (v ? "-=" : "+=") + c,
    ...
    t.effects.define("drop", "hide", (function(e, i) {
        var n, s = t(this), o = "show" === e.mode, r = e.direction || "left", a = "up" === r || "down" === r ? "top" : "left", l = "up" === r || "left" === r ? "-=" : "+=", h = "+=" === l ? "-=" : "+=", u = {
            opacity: 0
        };
    ...
    t.effects.define("explode", "hide", (function(e, i) {
        var n, s, o, r, a, l, h = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, u = h, c = t(this), d = "show" === e.mode, p = c.show().css("visibility", "hidden").offset(), f = Math.ceil(c.outerWidth() / u), g = Math.ceil(c.outerHeight() / h), m = [];
        function v() {
            m.push(this),
            m.length === h * u && (c.css({
                visibility: "visible"
    ...
    t.widget("ui.accordion", {
        ...
        _eventHandler: function(e) {
            ...
            e.preventDefault(),
            a && !s.collapsible || !1 === this._trigger("beforeActivate", e, c) || (s.active = !l && this.headers.index(r),
            this.active = a ? t() : r,
            this._toggle(c),
    ...
    t.extend(f.prototype, {
        ...
        _dialogDatepicker: function(e, i, n, s, o) {
            ...
            t.data(this._dialogInput[0], "datepicker", c)),
            v(c.settings, s || {}),
        ...
        _optionDatepicker: function(e, i, n) {
            ...
            v(l.settings, s),
            null !== r && void 0 !== s.dateFormat && void 0 === s.minDate && (l.settings.minDate = this._formatDate(l, r)),
            null !== a && void 0 !== s.dateFormat && void 0 === s.maxDate && (l.settings.maxDate = this._formatDate(l, a)),
        ...
        _showDatepicker: function(e) {
            ...
            !1 !== (s = (n = t.datepicker._get(i, "beforeShow")) ? n.apply(e, [e, i]) : {}) && (v(i.settings, s),
            i.lastVal = null,
            ...
            i.inline || (a = t.datepicker._get(i, "showAnim"),
            ...
            t.effects && t.effects.effect[a] ? i.dpDiv.show(a, t.datepicker._get(i, "showOptions"), l) : i.dpDiv[a || "show"](a ? l : null),
        ...
        _selectDate: function(e, i) {
            ...
            "object" !== _typeof(o.input[0]) && o.input.trigger("focus"),
            this._lastInput = null)
        },
        ...
        parseDate: function(e, i, n) {
            ...
            if ("" === (i = "object" === _typeof(i) ? i.toString() : i + ""))
                return null;
            ...
            if (-1 === g ? g = (new Date).getFullYear() : g < 100 && (g += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (g <= u ? 0 : -100)),
            _ > -1)
                for (m = 1,
                v = _; ; ) {
        ...
        _generateHTML: function(t) {
            ...
            i = $ ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt,Z - V,1)), this._getFormatConfig(t)) : i,
            n = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>" : Y ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>",
            s = this._get(t, "nextText"),
            s = $ ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt,Z + V,1)), this._getFormatConfig(t)) : s,
            o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + s + "</span></a>" : Y ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + s + "</span></a>",
            ...
            h = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (q ? l : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (q ? "" : l) + "</div>" : "",
            ...
            x = 0; x < U[0]; x++) {
                ...
                C = 0; C < U[1]; C++) {
                    ...
                    for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? q ? o : n : "") + (/all|right/.test(T) && 0 === x ? q ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || C > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    S = c ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
                    w = 0; w < 7; w++)
                        S += "<th scope='col'" + ((w + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[P = (w + u) % 7] + "'>" + p[P] + "</span></th>";
                    for (I += S + "</tr></thead><tbody>",
                    ...
                    ++Z > 11 && (Z = 0,
                    tt++),
                    k += I += "</tbody></table>" + (X ? "</div>" + (U[0] > 0 && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                y += k
            }
            return y += h,
        ...
        _generateMonthYearHeader: function(t, e, i, n, s, o, r, a) {
            ...
            if (o || !m)
                ...
                u = 0; u < 12; u++)
                    (!l || u >= n.getMonth()) && (!h || u <= s.getMonth()) && (y += "<option value='" + u + "'" + (u === e ? " selected='selected'" : "") + ">" + a[u] + "</option>");
                y += "</select>"
            }
            if (_ || (b += y + (!o && m && v ? "" : "&#xa0;")),
            !t.yearshtml)
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i, n) {
            ...
            for (d = n.snapElements.length - 1; d >= 0; d--)
                ...
                v < l - g || m > h + g || b < u - g || _ > c + g || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[d].item
                })),
                n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = Math.abs(u - b) <= g,
                o = Math.abs(c - _) <= g,
                r = Math.abs(l - v) <= g,
                a = Math.abs(h - m) <= g,
                ...
                p = s || o || r || a,
                "outer" !== f.snapMode && (s = Math.abs(u - _) <= g,
                o = Math.abs(c - b) <= g,
                r = Math.abs(l - m) <= g,
                a = Math.abs(h - v) <= g,
                s && (i.position.top = n._convertPositionTo("relative", {
    ...
    t.ui.plugin.add("resizable", "grid", {
        resize: function() {
            var e, i = t(this).resizable("instance"), n = i.options, s = i.size, o = i.originalSize, r = i.originalPosition, a = i.axis, l = "number" == typeof n.grid ? [n.grid, n.grid] : n.grid, h = l[0] || 1, u = l[1] || 1, c = Math.round((s.width - o.width) / h) * h, d = Math.round((s.height - o.height) / u) * u, p = o.width + c, f = o.height + d, g = n.maxWidth && n.maxWidth < p, m = n.maxHeight && n.maxHeight < f, v = n.minWidth && n.minWidth > p, _ = n.minHeight && n.minHeight > f;
            n.grid = l,
            v && (p += h),
            _ && (f += u),
            g && (p -= h),
    ...
    t.ui.ddmanager = {
        ...
        drop: function(e, i) {
            ...
            return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), (function() {
                this.options && (!this.options.disabled && this.visible && b(e, this, this.options.tolerance, i) && (n = this._drop.call(this, i) || n),
        ...
        drag: function(e, i) {
            ...
            t.each(t.ui.ddmanager.droppables[e.options.scope] || [], (function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var n, s, o, r = b(e, this, this.options.tolerance, i), a = !r && this.isover ? "isout" : r && !this.isover ? "isover" : null;
        ...
        _contactContainers: function(e) {
            ...
            if (d)
                if (1 === this.containers.length)
                    ...
                    for (s = 1e4,
                    o = null,
                    r = (u = d.floating || this._isFloating(this.currentItem)) ? "left" : "top",
                    a = u ? "width" : "height",
                    c = u ? "pageX" : "pageY",
