...
!function(e, t) {
    ...
    return function(e, t, n, o) {
        ...
        var l, s, u, c, d, p, m, f, h, v, y, x, g, w, b, C, I, T, E, S, D, _, M, F, O, k, A, R, L, P, Z, z, N, U, K, H, W, B, Y, G, q, V, X, j, $, J, Q, ee, te, ne, oe, ie, ae, re, le, se, ue = {
            ...
            x: 0,
            y: 0
        }, ve = 0, ye = !0, xe = [], ge = {}, we = !1, be = function(e, t) {
            ...
            (!we || i && i !== a.currItem) && (o /= i ? i.fitRatio : a.currItem.fitRatio),
            e[_] = x + t + "px, " + n + "px" + g + " scale(" + o + ")"
        }, Me = function(e) {
            te && (e && (v > a.currItem.fitRatio ? we || (jt(a.currItem, !1, !0),
            ...
            e.x = Math.round(e.x),
            e.y = Math.round(e.y)
        }, Pe = null, Ze = function t() {
            Pe && (i.unbind(document, "mousemove", t),
            ...
            init: function() {
                if (!l && !s) {
                    ...
                    Te("initialZoomInEnd", (function() {
                        ...
                        r.mouseUsed || i.bind(document, "mousemove", Ze),
            ...
            close: function() {
                ...
                i.unbind(document, "mousemove", Ze),
            ...
            updateCurrZoomItem: function(e) {
                ...
                y = v = a.currItem.initialZoomLevel,
                de.x = ee.center.x,
                de.y = ee.center.y,
                e && Ee("afterChange")
            },
                ...
                if (0 !== ve) {
                    ...
                    if (!(e && n < 2)) {
                        ...
                        for (var o = 0; o < n; o++)
                            ...
                            a.setContent(t, c - n + o + 1 + 1)) : (t = C.pop(),
                            C.unshift(t),
                            p--,
            ...
            updateSize: function(t) {
                ...
                void 0 !== p) {
                    for (var o, l, s, u = 0; u < 3; u++)
                        ...
                        s = c + u - 1,
                        r.loop && Kt() > 2 && (s = Ce(s)),
                        (l = Ut(s)) && (b || l.needsUpdate || !l.bounds) ? (a.cleanSlide(l),
                        a.setContent(o, s),
                        1 === u && (a.currItem = l,
                        a.updateCurrZoomItem(!0)),
                        l.needsUpdate = !1) : -1 === o.index && s >= 0 && a.setContent(o, s),
                        l && l.container && (Gt(l, pe),
                        jt(l),
                        Fe(l));
                    b = !1
                }
        ...
        }, Je = {}, Qe = {}, et = {}, tt = {}, nt = {}, ot = [], it = {}, at = [], rt = {}, lt = 0, st = {
            x: 0,
            y: 0
        }, ut = 0, ct = {
            x: 0,
            ...
            return yt.prevent = !vt(e.target, r.isClickableElement),
            Ee("preventDragEvent", e, t, yt),
            yt.prevent
        }, gt = function(e, t) {
            return t.x = e.pageX,
            t.y = e.pageY,
        ...
        }, Ct = {}, It = {}, Tt = [], Et = function(e) {
            for (; Tt.length > 0; )
                Tt.pop();
            return M ? (se = 0,
            ot.forEach((function(e) {
                0 === se ? Tt[0] = e : 1 === se && (Tt[1] = e),
                se++
            }
            ))) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Tt[0] = gt(e.touches[0], Ct),
            e.touches.length > 1 && (Tt[1] = gt(e.touches[1], It))) : (Ct.x = e.pageX,
            Ct.y = e.pageY,
            Ct.id = "",
            Tt[0] = Ct),
            Tt
            ...
            return n = s > ee.min[e] || s < ee.max[e] ? r.panEndFriction : 1,
            s = de[e] + t[e] * n,
            !r.allowPanToNext && v !== a.currItem.initialZoomLevel || (te ? "h" !== oe || "x" !== e || q || (u ? (s > ee.min[e] && (n = r.panEndFriction,
            ee.min[e] - s,
            o = ee.min[e] - ce[e]),
            (o <= 0 || d < 0) && Kt() > 1 ? (l = c,
            d < 0 && c > it.x && (l = it.x)) : ee.min.x !== ee.max.x && (i = s)) : (s < ee.max[e] && (n = r.panEndFriction,
            s - ee.max[e],
            o = ce[e] - ee.max[e]),
            (o <= 0 || d > 0) && Kt() > 1 ? (l = c,
            d > 0 && c < it.x && (l = it.x)) : ee.min.x !== ee.max.x && (i = s))) : l = c,
            "x" !== e) ? void (ne || j || v > a.currItem.fitRatio && (de[e] += t[e] * n)) : (void 0 !== l && (ke(l, !0),
            j = l !== it.x),
            ee.min.x !== ee.max.x && (void 0 !== i ? de.x = i : j || (de.x += t.x * n)),
            void 0 !== l)
        }, Dt = function(e) {
            ...
            var o, l = Et(e), s = l.length;
            if ("mouseup" === e.type && (s = 0),
            2 === s)
                return $ = null,
                !0;
            1 === s && Re(nt, l[0]),
            0 !== s || oe || ne || (t || ("mouseup" === e.type ? t = {
                x: e.pageX,
                y: e.pageY,
                type: "mouse"
            ...
            V || q || ne || W)
                ...
                W) {
                    ...
                    if (!ne)
                        return "swipe" !== o ? void Lt() : void (!j && v > a.currItem.fitRatio && kt(K))
                }
        }, Ot = function() {
            var e, t, n = {
                lastFlickOffset: {},
                ...
                calculateSwipeSpeed: function(o) {
                    at.length > 1 ? (e = Se() - U + 50,
                    t = at[at.length - 2][o]) : (e = Se() - N,
                    t = nt[o]),
                ...
                calculateOverBoundsAnimOffset: function(e, t) {
                    ...
                    je("bounceZoomPan" + e, de[e], n.backAnimDestination[e], t || 300, i.easing.sine.out, (function(t) {
                        de[e] = t,
                        Me()
                    }
                    )))))
            ...
            o && ((c += o) < 0 ? (c = r.loop ? Kt() - 1 : 0,
            l = !0) : c >= Kt() && (c = r.loop ? 0 : Kt() - 1,
            l = !0),
            l && !r.loop || (ve += o,
            me -= o,
            n = !0));
            var d, p = he.x * me, m = Math.abs(p - ct.x);
            return n || p > ct.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? m / Math.abs(t.lastFlickSpeed.x) : 333,
            d = Math.min(d, 400),
        ...
        be("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    (M = Z.pointerEvent) && Z.touch && (Z.touch = !1),
                    M ? navigator.msPointerEnabled ? e("MSPointer", "Down", "Move", "Up", "Cancel") : e("pointer", "down", "move", "up", "cancel") : Z.touch ? (e("touch", "start", "move", "end", "cancel"),
                    F = !0) : e("mouse", "down", "move", "up"),
                    m = E + " " + S + " " + D,
                    f = T,
                    M && !F && (F = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1),
        ...
        var Pt, Zt, zt, Nt, Ut, Kt, Ht = function(t, n, o, l) {
            ...
            var d = o ? r.hideAnimationDuration : r.showAnimationDuration
              , p = function() {
                ...
                a.bg.removeAttribute("style")) : (De(1),
                    ...
                    o) {
                        var a = s.w / t.w
                          ...
                          , m = function(t) {
                            1 === t ? (v = a,
                            de.x = s.x,
                            de.y = s.y - P) : (v = (a - u) * t + u,
                            de.x = (s.x - r.x) * t + r.x,
                            de.y = (s.y - P - r.y) * t + r.y),
                            Me(),
                            l ? e.style.opacity = 1 - t : De(c - t * c)
                        };
                        n ? je("initialZoom", 0, 1, d, i.easing.cubic.out, m, p) : (m(1),
                        Pt = setTimeout(p, d + 20))
                    } else
                        v = t.initialZoomLevel,
                        Re(de, t.initialPosition),
                        Me(),
            ...
            if (e.src && !e.loadError) {
                ...
                return function(e, t, n) {
                    ...
                    o.max.y = n > Wt.y ? Math.round(Wt.y - n) + e.vGap.top : o.center.y,
            ...
            if (Bt.length) {
                for (var e, t = 0; t < Bt.length; t++)
                    (e = Bt[t]).holder.index === e.index && qt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                Bt = []
            }
        };
        be("Controller", {
            publicMethods: {
                lazyLoadItem: function(e) {
                    e = Ce(e);
                    var t = Ut(e);
                    t && (!t.loaded && !t.loading || b) && (Ee("gettingData", e, t),
                    t.src && Vt(t))
                },
                initController: function() {
                    ...
                    Te("beforeChange", (function(e) {
                        var t, n = r.preload, o = null === e || e >= 0, i = Math.min(n[0], Kt()), l = Math.min(n[1], Kt());
                        for (t = 1; t <= (o ? l : i); t++)
                            a.lazyLoadItem(c + t);
                        for (t = 1; t <= (o ? i : l); t++)
                            a.lazyLoadItem(c - t)
                ...
                setContent: function(e, t) {
                    ...
                    if (s) {
                        ...
                        !s.src || s.loadError || s.loaded)
                            s.src && !s.loadError && ((o = i.createEl("pswp__img", "img")).style.opacity = 1,
                            o.src = s.src,
                            jt(s, o),
                            qt(0, s, u, o));
                        else {
                            if (s.loadComplete = function(n) {
                                if (l) {
                                    if (e && e.index === t) {
                                        ...
                                        n.imageAppended ? !Nt && n.placeholder && (n.placeholder.style.display = "none",
                                        n.placeholder = null) : Z.transform && (ne || Nt) ? Bt.push({
                                            item: n,
                                            baseDiv: u,
                                            img: n.img,
                                            index: t,
                            ...
                            s.loading || Vt(s),
                            a.allowProgressiveImg() && (!zt && Z.transform ? Bt.push({
                                item: s,
                                baseDiv: u,
                                img: s.img,
                                index: t,
            ...
            publicMethods: {
                ...
                handleMouseWheel: function(e) {
                    if (v <= a.currItem.fitRatio)
                        return r.modal && (!r.closeOnScroll || Ge || Y ? e.preventDefault() : _ && Math.abs(e.deltaY) > 2 && (u = !0,
                        a.close())),
                        !0;
        ...
        var nn, on, an, rn, ln, sn, un, cn, dn, pn, mn, fn, hn = {
            ...
            Ge || Y)
                ...
                fn ? "#" + o !== window.location.hash && history[cn ? "replaceState" : "pushState"]("", document.title, i) : cn ? mn.replace(i) : mn.hash = o,
                cn = !0,
            ...
            publicMethods: {
                initHistory: function() {
                    ...
                    r.history) {
                        ...
                        var e = function() {
                            sn = !0,
                            dn || (pn ? history.back() : un ? mn.hash = un : fn ? history.pushState("", document.title, mn.pathname + mn.search) : mn.hash = ""),
                            yn()
                        };
                        Te("unbindEvents", (function() {
                            u && e()
                ...
                onHashChange: function() {
                    return vn() === un ? (dn = !0,
                    void a.close()) : void (rn || (ln = !0,
                    a.goTo(xn().pid),
                    ln = !1))
                },
                updateURL: function() {
                    yn(),
                    ln || (cn ? nn = setTimeout(gn, 800) : gn())
                }
            }
        }),
        i.extend(a, $e)
...
function(e, t) {
    ...
    "use strict";
    return function(e, t) {
        var n, o, i, a, r, l, s, u, c, d, p, m, f, h, v, y, x, g, w = this, b = !1, C = !0, I = !0, T = {
            barsSize: {
                top: 44,
                bottom: "auto"
            },
            ...
            if (y)
                return !0;
            e = e || window.event,
            v.timeToIdle && v.mouseUsed && !c && R();
            for (var n, o, i = (e.target || e.srcElement).getAttribute("class") || "", a = 0; a < z.length; a++)
                (n = z[a]).onTap && i.indexOf("pswp__" + n.name) > -1 && (n.onTap(),
                o = !0);
            if (o) {
            ...
            s.children[0].innerHTML = i,
            s.children[0].onclick = F
        }, k = function(e) {
            ...
            t && "HTML" !== t.nodeName || (clearTimeout(g),
            ...
            if (!e.likelyTouchDevice || v.mouseUsed || screen.width > v.fitControlsWidth) {
                ...
                if (v.captionEl && "auto" === l.bottom)
                    ...
                    r.bottom = "auto" === l.bottom ? 0 : l.bottom;
                r.top = l.top
            } else
                r.top = r.bottom = 0
        }, z = [{
