function _typeof(e) {
    ...
    return function(e, t, n, o) {
        ...
        i.extend(r, o);
        var l, s, u, c, d, p, m, f, h, v, y, x, g, w, b, C, I, T, E, S, D, _, M, F, O, k, A, R, L, P, Z, z, N, U, K, H, W, B, Y, G, q, V, X, j, $, J, Q, ee, te, ne, oe, ie, ae, re, le, se, ue = {
                x: 0,
                y: 0
            },
            ce = {
            ...
            we = !1,
            be = function(e, t) {
                i.extend(a, t.publicMethods), xe.push(e)
            },
            Ce = function(e) {
                var t = Kt();
            ...
            _e = function(e, t, n, o, i) {
                (!we || i && i !== a.currItem) && (o /= i ? i.fitRatio : a.currItem.fitRatio), e[_] = x + t + "px, " + n + "px" + g + " scale(" + o + ")"
            },
            Me = function(e) {
                te && (e && (v > a.currItem.fitRatio ? we || (jt(a.currItem, !1, !0), we = !0) : we && (jt(a.currItem), we = !1)), _e(te, de.x, de.y, v))
            },
            Fe = function(e) {
            ...
            ke = function(e, t) {
                if (!r.loop && t) {
                    var n = c + (he.x * me - e) / he.x,
                        o = Math.round(e - ct.x);
                    (n < 0 && o > 0 || n >= Kt() - 1 && o < 0) && (e = ct.x + o * r.mainScrollEndFriction)
                }
                ct.x = e, Oe(e, d)
            },
            Ae = function(e, t) {
            ...
            Pe = null,
            Ze = function t() {
                Pe && (i.unbind(document, "mousemove", t), i.addClass(e, "pswp--has_mouse"), r.mouseUsed = !0, Ee("mouseUsed")), Pe = setTimeout((function() {
                    Pe = null
                }), 100)
            },
            ze = function(e, t) {
            ...
            Ke = function(e, t, n, o) {
                return o === a.currItem.initialZoomLevel ? (n[e] = a.currItem.initialPosition[e], !0) : (n[e] = Ae(e, o), n[e] > t.min[e] ? (n[e] = t.min[e], !0) : n[e] < t.max[e] && (n[e] = t.max[e], !0))
            },
            He = function(e) {
                var t = "";
            ...
            je = function(e, t, n, o, i, a, r) {
                ...
                ! function u() {
                    if (Ye[e]) {
                        if ((l = Se() - s) >= o) return qe(e), a(n), void(r && r());
            ...
            $e = {
                ...
                init: function() {
                    if (!l && !s) {
                        var n;
                        a.framework = i, a.template = e, a.bg = i.getChildByClass(e, "pswp__bg"), A = e.className, l = !0, Z = i.detectFeatures(), O = Z.raf, k = Z.caf, _ = Z.transform, L = Z.oldIE, a.scrollWrap = i.getChildByClass(e, "pswp__scroll-wrap"), a.container = i.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = C = [{
                            ...
                            function() {
                                if (_) {
                                    ...
                                    return x = "translate" + (t ? "3d(" : "("), void(g = Z.perspective ? ", 0px)" : ")")
                                }
                                _ = "left", i.addClass(e, "pswp--ie"), Oe = function(e, t) {
                                    t.left = e + "px"
                                }, Fe = function(e) {
                        ...
                        for (Z.animationName && Z.transform && !o || (r.showAnimationDuration = r.hideAnimationDuration = 0), n = 0; n < xe.length; n++) a["init" + xe[n]]();
                        if (t)(a.ui = new t(a, i)).init();
                        Ee("firstUpdate"), c = c || r.index || 0, (isNaN(c) || c < 0 || c >= Kt()) && (c = 0), a.currItem = Ut(c), (Z.isOldIOSPhone || Z.isOldAndroid) && (ye = !1), e.setAttribute("aria-hidden", "false"), r.modal && (ye ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = i.getScrollY() + "px")), void 0 === P && (Ee("initialLayout"), P = R = i.getScrollY());
                        var u = "pswp--open ";
                        for (r.mainClass && (u += r.mainClass + " "), r.showHideOpacity && (u += "pswp--animate_opacity "), u += F ? "pswp--touch" : "pswp--notouch", u += Z.animationName ? " pswp--css_animation" : "", u += Z.svg ? " pswp--svg" : "", i.addClass(e, u), a.updateSize(), p = -1, ve = null, n = 0; n < 3; n++) Oe((n + p) * he.x, C[n].el.style);
                        L || i.bind(a.scrollWrap, f, a), Te("initialZoomInEnd", (function() {
                            a.setContent(C[0], c - 1), a.setContent(C[2], c + 1), C[0].el.style.display = C[2].el.style.display = "block", r.focus && e.focus(), i.bind(document, "keydown", a), Z.transform && i.bind(a.scrollWrap, "click", a), r.mouseUsed || i.bind(document, "mousemove", Ze), i.bind(window, "resize scroll orientationchange", a), Ee("bindEvents")
                        })), a.setContent(C[1], c), a.updateCurrItem(), Ee("afterInit"), ye || (w = setInterval((function() {
                            Ge || Y || J || v !== a.currItem.initialZoomLevel || a.updateSize()
                        }), 1e3)), i.addClass(e, "pswp--visible")
                    }
                },
                close: function() {
                    l && (l = !1, s = !0, Ee("close"), i.unbind(window, "resize scroll orientationchange", a), i.unbind(window, "scroll", h.scroll), i.unbind(document, "keydown", a), i.unbind(document, "mousemove", Ze), Z.transform && i.unbind(a.scrollWrap, "click", a), Y && i.unbind(window, m, a), clearTimeout(z), Ee("unbindEvents"), Ht(a.currItem, null, !0, a.destroy))
                },
                destroy: function() {
                    Ee("destroy"), Pt && clearTimeout(Pt), e.setAttribute("aria-hidden", "true"), e.className = A, w && clearInterval(w), i.unbind(a.scrollWrap, f, a), i.unbind(window, "scroll", a), ft(), Xe(), Ie = null
                },
                ...
                goTo: function(e) {
                    var t = (e = Ce(e)) - c;
                    ve = t, c = e, a.currItem = Ut(c), me -= t, ke(he.x * me), Xe(), ne = !1, a.updateCurrItem()
                },
                next: function() {
                    a.goTo(c + 1)
                },
                ...
                updateCurrZoomItem: function(e) {
                    ...
                    ee = a.currItem.bounds, y = v = a.currItem.initialZoomLevel, de.x = ee.center.x, de.y = ee.center.y, e && Ee("afterChange")
                },
                ...
                updateCurrItem: function(e) {
                    if (0 !== ve) {
                        var t, n = Math.abs(ve);
                        if (!(e && n < 2)) {
                            a.currItem = Ut(c), we = !1, Ee("beforeChange", ve), n >= 3 && (p += ve + (ve > 0 ? -3 : 3), n = 3);
                            for (var o = 0; o < n; o++) ve > 0 ? (t = C.shift(), C[2] = t, p++, Oe((p + 2) * he.x, t.el.style), a.setContent(t, c - n + o + 1 + 1)) : (t = C.pop(), C.unshift(t), p--, Oe(p * he.x, t.el.style), a.setContent(t, c + n - o - 1 - 1));
                            if (te && 1 === Math.abs(ve)) {
                                var i = Ut(I);
                ...
                updateSize: function(t) {
                    if (!ye && r.modal) {
                        var n = i.getScrollY();
                        if (P !== n && (e.style.top = n + "px", P = n), !t && ge.x === window.innerWidth && ge.y === window.innerHeight) return;
                        ge.x = window.innerWidth, ge.y = window.innerHeight, e.style.height = ge.y + "px"
                    }
                    if (pe.x = a.scrollWrap.clientWidth, pe.y = a.scrollWrap.clientHeight, Be(), he.x = pe.x + Math.round(pe.x * r.spacing), he.y = pe.y, ke(he.x * me), Ee("beforeResize"), void 0 !== p) {
                        for (var o, l, s, u = 0; u < 3; u++) o = C[u], Oe((u + p) * he.x, o.el.style), s = c + u - 1, r.loop && Kt() > 2 && (s = Ce(s)), (l = Ut(s)) && (b || l.needsUpdate || !l.bounds) ? (a.cleanSlide(l), a.setContent(o, s), 1 === u && (a.currItem = l, a.updateCurrZoomItem(!0)), l.needsUpdate = !1) : -1 === o.index && s >= 0 && a.setContent(o, s), l && l.container && (Gt(l, pe), jt(l), Fe(l));
                        b = !1
                    }
                    y = v = a.currItem.initialZoomLevel, (ee = a.currItem.bounds) && (de.x = ee.center.x, de.y = ee.center.y, Me(!0)), Ee("resize")
                },
                zoomTo: function(e, t, n, o, a) {
                    t && (y = v, dt.x = Math.abs(t.x) - de.x, dt.y = Math.abs(t.y) - de.y, Re(ce, de));
                    var r = ze(e, !1),
                        l = {};
                    ...
                    Le(l);
                    var d = function(t) {
                        1 === t ? (v = e, de.x = l.x, de.y = l.y) : (v = (e - s) * t + s, de.x = (l.x - u) * t + u, de.y = (l.y - c) * t + c), a && a(t), Me(1 === t)
                    };
            ...
            yt = {},
            xt = function(e, t) {
                return yt.prevent = !vt(e.target, r.isClickableElement), Ee("preventDragEvent", e, t, yt), yt.prevent
            },
            gt = function(e, t) {
            ...
            Et = function(e) {
                ...
                return M ? (se = 0, ot.forEach((function(e) {
                    0 === se ? Tt[0] = e : 1 === se && (Tt[1] = e), se++
                }))) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Tt[0] = gt(e.touches[0], Ct), e.touches.length > 1 && (Tt[1] = gt(e.touches[1], It))) : (Ct.x = e.pageX, Ct.y = e.pageY, Ct.id = "", Tt[0] = Ct), Tt
            },
            St = function(e, t) {
                var n, o, i, l, s = de[e] + t[e],
                    ...
                    c = ct.x + t.x,
                    d = ct.x - it.x;
                return n = s > ee.min[e] || s < ee.max[e] ? r.panEndFriction : 1, s = de[e] + t[e] * n, !r.allowPanToNext && v !== a.currItem.initialZoomLevel || (te ? "h" !== oe || "x" !== e || q || (u ? (s > ee.min[e] && (n = r.panEndFriction, ee.min[e] - s, o = ee.min[e] - ce[e]), (o <= 0 || d < 0) && Kt() > 1 ? (l = c, d < 0 && c > it.x && (l = it.x)) : ee.min.x !== ee.max.x && (i = s)) : (s < ee.max[e] && (n = r.panEndFriction, s - ee.max[e], o = ce[e] - ee.max[e]), (o <= 0 || d > 0) && Kt() > 1 ? (l = c, d > 0 && c < it.x && (l = it.x)) : ee.min.x !== ee.max.x && (i = s))) : l = c, "x" !== e) ? void(ne || j || v > a.currItem.fitRatio && (de[e] += t[e] * n)) : (void 0 !== l && (ke(l, !0), j = l !== it.x), ee.min.x !== ee.max.x && (void 0 !== i ? de.x = i : j || (de.x += t.x * n)), void 0 !== l)
            },
            Dt = function(e) {
                if (!("mousedown" === e.type && e.button > 0)) {
                    if (Nt) return void e.preventDefault();
                    if (!B || "mousedown" !== e.type) {
                        if (xt(e, !0) && e.preventDefault(), Ee("pointerDown"), M) {
                        ...
                        var n = Et(e),
                            o = n.length;
                        $ = null, Xe(), Y && 1 !== o || (Y = ie = !0, i.bind(window, m, a), H = le = ae = W = j = V = G = q = !1, oe = null, Ee("firstTouchStart", n), Re(ce, de), ue.x = ue.y = 0, Re(tt, n[0]), Re(nt, tt), it.x = he.x * me, at = [{
                            x: tt.x,
                            y: tt.y
                        }], U = N = Se(), ze(v, !0), ft(), ht()), !J && o > 1 && !ne && !j && (y = v, q = !1, J = G = !0, ue.y = ue.x = 0, Re(ce, de), Re(Je, n[0]), Re(Qe, n[1]), wt(Je, Qe, pt), dt.x = Math.abs(pt.x) - de.x, dt.y = Math.abs(pt.y) - de.y, Q = mt(Je, Qe))
                    }
                }
            },
            _t = function(e) {
            ...
            Mt = function() {
                if ($) {
                    var e = $.length;
                    if (0 !== e)
                        if (Re(Je, $[0]), et.x = Je.x - tt.x, et.y = Je.y - tt.y, J && e > 1) {
                            ...
                            o < 0 && (o = 0), t, wt(Je, Qe, st), ue.x += st.x - pt.x, ue.y += st.y - pt.y, Re(pt, st), de.x = Ae("x", n), de.y = Ae("y", n), H = n > v, v = n, Me()
                        } else {
                            if (!oe) return;
                            ...
                            if ("v" === oe && r.closeOnVerticalDrag && "fit" === r.scaleMode && v === a.currItem.initialZoomLevel) {
                                ue.y += et.y, de.y += et.y;
                                var u = bt();
                                return W = !0, Ee("onVerticalDrag", u), De(u), void Me()
                            }(function(e, t, n) {
                                if (e - U > 50) {
                                    var o = at.length > 2 ? at.shift() : {};
                                    o.x = t, o.y = n, at.push(o), U = e
                                }
                            })(Se(), Je.x, Je.y), V = !0, ee = a.currItem.bounds, St("x", et) || (St("y", et), Le(de), Me())
                        }
                }
            },
            Ft = function(e) {
                ...
                var t;
                if (Ee("pointerUp"), xt(e, !1) && e.preventDefault(), M) {
                ...
                var u = -1;
                if (0 === s && (Y = !1, i.unbind(window, m, a), ft(), J ? u = 0 : -1 !== ut && (u = Se() - ut)), ut = 1 === s ? Se() : -1, o = -1 !== u && u < 150 ? "zoom" : "swipe", J && s < 2 && (J = !1, 1 === s && (o = "zoomPointerUp"), Ee("zoomGestureEnded")), $ = null, V || q || ne || W)
                    if (Xe(), K || (K = Ot()), K.calculateSwipeSpeed("x"), W) {
                        if (bt() < r.verticalDragRange) a.close();
                            ...
                            je("verticalDrag", 0, 1, 300, i.easing.cubic.out, (function(e) {
                                de.y = (a.currItem.initialPosition.y - c) * e + c, De((1 - d) * e + d), Me()
                            })), Ee("onVerticalDrag", 1)
                        }
                    } else {
                        if ((j || ne) && 0 === s) {
                        ...
                        if (!ne) return "swipe" !== o ? void Lt() : void(!j && v > a.currItem.fitRatio && kt(K))
                    }
            },
            Ot = function() {
                var e, t, n = {
            ...
            At = function(e, t) {
                ...
                o && ((c += o) < 0 ? (c = r.loop ? Kt() - 1 : 0, l = !0) : c >= Kt() && (c = r.loop ? 0 : Kt() - 1, l = !0), l && !r.loop || (ve += o, me -= o, n = !0));
                var d, p = he.x * me,
                    m = Math.abs(p - ct.x);
                return n || p > ct.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? m / Math.abs(t.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, lt === c && (n = !1), ne = !0, Ee("mainScrollAnimStart"), je("mainScroll", ct.x, p, d, i.easing.cubic.out, ke, (function() {
                    Xe(), ne = !1, lt = -1, (n || lt !== c) && a.updateCurrItem(), Ee("mainScrollAnimComplete")
            ...
            Lt = function() {
                ...
                v < t ? e = t : v > n && (e = n);
                var o, r = re;
                return ae && !H && !le && v < t ? (a.close(), !0) : (ae && (o = function(e) {
                    De((1 - r) * e + r)
            ...
            publicMethods: {
                initGestures: function() {
                    var e = function(e, t, n, o, i) {
                        T = e + t, E = e + n, S = e + o, D = i ? e + i : ""
                    };
                    (M = Z.pointerEvent) && Z.touch && (Z.touch = !1), M ? navigator.msPointerEnabled ? e("MSPointer", "Down", "Move", "Up", "Cancel") : e("pointer", "down", "move", "up", "cancel") : Z.touch ? (e("touch", "start", "move", "end", "cancel"), F = !0) : e("mouse", "down", "move", "up"), m = E + " " + S + " " + D, f = T, M && !F && (F = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = F, h[T] = Dt, h[E] = _t, h[S] = Ft, D && (h[D] = h[S]), Z.touch && (f += " mousedown", m += " mousemove mouseup", h.mousedown = h[T], h.mousemove = h[E], h.mouseup = h[S]), F || (r.allowPanToNext = !1)
                }
            }
        });
        var Pt, Zt, zt, Nt, Ut, Kt, Ht = function(t, n, o, l) {
                var s;
                Pt && clearTimeout(Pt), Nt = !0, zt = !0, t.initialLayout ? (s = t.initialLayout, t.initialLayout = null) : s = r.getThumbBoundsFn && r.getThumbBoundsFn(c);
                var d = o ? r.hideAnimationDuration : r.showAnimationDuration,
                    p = function() {
                        qe("initialZoom"), o ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (De(1), n && (n.style.display = "block"), i.addClass(e, "pswp--animated-in"), Ee("initialZoom" + (o ? "OutEnd" : "InEnd"))), l && l(), Nt = !1
                    };
                if (!d || !s || void 0 === s.x) return Ee("initialZoom" + (o ? "Out" : "In")), v = t.initialZoomLevel, Re(de, t.initialPosition), Me(), e.style.opacity = o ? 0 : 1, De(1), void(d ? setTimeout((function() {
                    p()
                }), d) : p());
                ! function() {
                    var n = u,
                        l = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
                    t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), o || (v = s.w / t.w, de.x = s.x, de.y = s.y - R, a[l ? "template" : "bg"].style.opacity = .001, Me()), Ve("initialZoom"), o && !n && i.removeClass(e, "pswp--animated-in"), l && (o ? i[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout((function() {
                        ...
                        if (Ee("initialZoom" + (o ? "Out" : "In")), o) {
                            var a = s.w / t.w,
                                ...
                                c = re,
                                m = function(t) {
                                    1 === t ? (v = a, de.x = s.x, de.y = s.y - P) : (v = (a - u) * t + u, de.x = (s.x - r.x) * t + r.x, de.y = (s.y - P - r.y) * t + r.y), Me(), l ? e.style.opacity = 1 - t : De(c - t * c)
                                };
                            n ? je("initialZoom", 0, 1, d, i.easing.cubic.out, m, p) : (m(1), Pt = setTimeout(p, d + 20))
                        } else v = t.initialZoomLevel, Re(de, t.initialPosition), Me(), De(1), l ? e.style.opacity = 1 : De(1), Pt = setTimeout(p, d + 20)
                    }), o ? 25 : 90)
                }()
            },
            Wt = {},
            ...
            Gt = function(e, t, n) {
                if (e.src && !e.loadError) {
                    ...
                    if (o && (e.vGap || (e.vGap = {
                            top: 0,
                            bottom: 0
                        }), Ee("parseVerticalMargin", e)), Wt.x = t.x, Wt.y = t.y - e.vGap.top - e.vGap.bottom, o) {
                        var i = Wt.x / e.w,
                            a = Wt.y / e.h;
                        e.fitRatio = i < a ? i : a;
                        var l = r.scaleMode;
            ...
            qt = function(e, t, n, o, i, r) {
                t.loadError || o && (t.imageAppended = !0, jt(t, o, t === a.currItem && we), n.appendChild(o), r && setTimeout((function() {
            ...
            $t = function() {
                if (Bt.length) {
                    for (var e, t = 0; t < Bt.length; t++)(e = Bt[t]).holder.index === e.index && qt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                    Bt = []
                }
            };
        be("Controller", {
            publicMethods: {
                lazyLoadItem: function(e) {
                    e = Ce(e);
                    var t = Ut(e);
                    t && (!t.loaded && !t.loading || b) && (Ee("gettingData", e, t), t.src && Vt(t))
                },
                initController: function() {
                    i.extend(r, Yt, !0), a.items = Zt = n, Ut = a.getItemAt, Kt = r.getNumItemsFn, r.loop, Kt() < 3 && (r.loop = !1), Te("beforeChange", (function(e) {
                        var t, n = r.preload,
                            o = null === e || e >= 0,
                            i = Math.min(n[0], Kt()),
                            l = Math.min(n[1], Kt());
                    ...
                    })), Te("mainScrollAnimComplete", $t), Te("initialZoomInEnd", $t), Te("destroy", (function() {
                ...
                allowProgressiveImg: function() {
                    return r.forceProgressiveLoading || !F || r.mouseUsed || screen.width > 1200
                },
                setContent: function(e, t) {
                    ...
                    if (s) {
                        ...
                        if (!s.src && s.html && (s.html.tagName ? u.appendChild(s.html) : u.innerHTML = s.html), Xt(s), Gt(s, pe), !s.src || s.loadError || s.loaded) s.src && !s.loadError && ((o = i.createEl("pswp__img", "img")).style.opacity = 1, o.src = s.src, jt(s, o), qt(0, s, u, o));
                        else {
                            if (s.loadComplete = function(n) {
                                    if (l) {
                                        if (e && e.index === t) {
                                            if (Xt(n, !0)) return n.loadComplete = n.img = null, Gt(n, pe), Fe(n), void(e.index === c && a.updateCurrZoomItem());
                            ...
                            s.loading || Vt(s), a.allowProgressiveImg() && (!zt && Z.transform ? Bt.push({
                                item: s,
                                baseDiv: u,
                                img: s.img,
                                index: t,
                        ...
                        zt || t !== c ? Fe(s) : (te = u.style, Ht(s, o || s.img)), e.el.innerHTML = "", e.el.appendChild(u)
                    } else e.el.innerHTML = ""
                },
        ...
        be("Tap", {
                ...
                onTapRelease: function(e, t) {
                    if (t && !V && !G && !Ge) {
                        ...
                        if (Jt && (clearTimeout(Jt), Jt = null, function(e, t) {
                            ...
                            }(n, en))) return void Ee("doubleTap", n);
            ...
            publicMethods: {
                ...
                handleMouseWheel: function(e) {
                    if (v <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Ge || Y ? e.preventDefault() : _ && Math.abs(e.deltaY) > 2 && (u = !0, a.close())), !0;
        ...
        var nn, on, an, rn, ln, sn, un, cn, dn, pn, mn, fn, hn = {
            ...
            gn = function e() {
                if (an && clearTimeout(an), Ge || Y) an = setTimeout(e, 500);
                else {
                    rn ? clearTimeout(on) : rn = !0;
                    var t = c + 1,
                        n = Ut(c);
                    n.hasOwnProperty("pid") && (t = n.pid);
                    var o = un + "&gid=" + r.galleryUID + "&pid=" + t;
                    cn || -1 === mn.hash.indexOf(o) && (pn = !0);
                    var i = mn.href.split("#")[0] + "#" + o;
                    fn ? "#" + o !== window.location.hash && history[cn ? "replaceState" : "pushState"]("", document.title, i) : cn ? mn.replace(i) : mn.hash = o, cn = !0, on = setTimeout((function() {
                        rn = !1
                    }), 60)
                }
            };
            ...
            publicMethods: {
                initHistory: function() {
                    if (i.extend(r, hn, !0), r.history) {
                        mn = window.location, pn = !1, dn = !1, cn = !1, un = vn(), fn = "pushState" in history, un.indexOf("gid=") > -1 && (un = (un = un.split("&gid=")[0]).split("?gid=")[0]), Te("afterChange", a.updateURL), Te("unbindEvents", (function() {
                            i.unbind(window, "hashchange", a.onHashChange)
                        }));
                        var e = function() {
                            sn = !0, dn || (pn ? history.back() : un ? mn.hash = un : fn ? history.pushState("", document.title, mn.pathname + mn.search) : mn.hash = ""), yn()
                        };
                        Te("unbindEvents", (function() {
                            u && e()
                        })), Te("destroy", (function() {
                ...
                onHashChange: function() {
                    return vn() === un ? (dn = !0, void a.close()) : void(rn || (ln = !0, a.goTo(xn().pid), ln = !1))
                },
                updateURL: function() {
...
function(e, t) {
    ...
    "use strict";
    return function(e, t) {
        var n, o, i, a, r, l, s, u, c, d, p, m, f, h, v, y, x, g, w = this,
            b = !1,
            C = !0,
            I = !0,
            T = {
            ...
            F = function(t) {
                ...
                return e.shout("shareLinkClick", t, n), !(!n.href || !n.hasAttribute("download") && (window.open(n.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), I || M(), 1))
            },
            O = function() {
            ...
            A = 0,
            R = function() {
                clearTimeout(g), A = 0, c && w.setIdle(!1)
            },
            L = function(e) {
        ...
        w.init = function() {
            t.extend(e.options, T, !0), v = e.options, o = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen,
                function() {
                    ...
                    I || M(), x && clearInterval(x), t.unbind(document, "mouseout", L), t.unbind(document, "mousemove", R), t.unbind(o, "pswpTap click", E), t.unbind(e.scrollWrap, "pswpTap", w.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", w.onMouseOver), n && (t.unbind(document, n.eventK, w.updateFullscreen), n.isFullscreen() && (v.hideAnimationDuration = 0, n.exit()), n = null)
                })), d("destroy", (function() {
                ...
                function() {
                    ...
                    t.bind(document, "mousemove", R), t.bind(document, "mouseout", L), x = setInterval((function() {
                        2 == ++A && w.setIdle(!0)
                    }), v.timeToIdle / 2)
                })), v.fullscreenEl && !t.features.isOldAndroid && (n || (n = w.getFullscreenAPI()), n ? (t.bind(document, n.eventK, w.updateFullscreen), w.updateFullscreen(), t.addClass(e.template, "pswp--supports-fs")) : t.removeClass(e.template, "pswp--supports-fs")), v.preloaderEl && (P(!0), d("beforeChange", (function() {
            ...
            C && e.currItem ? (w.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(e.currItem, i), S(i, "caption--empty", !e.currItem.title)), b = !0) : b = !1, I || M(), D()
            ...
            if (!y)
                ...
                } else if (v.tapToToggleControls && (C ? w.hideControls() : w.showControls()), v.tapToClose && (t.hasClass(o, "pswp__img") || k(o))) return void e.close()
        }, w.onMouseOver = function(e) {
            var t = (e = e || window.event).target || e.srcElement;
            S(o, "ui--over-close", k(t))
