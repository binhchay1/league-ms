    ...
    $.extend(Timepicker.prototype, {
        ...
        _newInst: function(target, inline) {
            ...
            return {
                ...
                input: target,
                inline: inline,
                tpDiv: (!inline ? this.tpDiv : $('<div class="' + this._inlineClass + ' ui-timepicker ui-widget  ui-helper-clearfix"></div>'))
            }
        },
        ...
        _showTimepicker: function(input) {
            ...
            if ($.timepicker._curInst && $.timepicker._curInst != inst) {
                $.timepicker._curInst.tpDiv.stop(!0, !0)
            }
            ...
            inst._hoursClicked = !1;
            inst._minutesClicked = !1;
        ...
        _generateHTML: function(inst) {
            var h, m, row, col, html, hoursHtml, minutesHtml = '', showPeriod = (this._get(inst, 'showPeriod') == !0), showPeriodLabels = (this._get(inst, 'showPeriodLabels') == !0), showLeadingZero = (this._get(inst, 'showLeadingZero') == !0), showHours = (this._get(inst, 'showHours') == !0), showMinutes = (this._get(inst, 'showMinutes') == !0), amPmText = this._get(inst, 'amPmText'), rows = this._get(inst, 'rows'), amRows = 0, pmRows = 0, amItems = 0, pmItems = 0, amFirstRow = 0, pmFirstRow = 0, hours = Array(), hours_options = this._get(inst, 'hours'), hoursPerRow = null, hourCounter = 0, hourLabel = this._get(inst, 'hourText'), showCloseButton = this._get(inst, 'showCloseButton'), closeButtonText = this._get(inst, 'closeButtonText'), showNowButton = this._get(inst, 'showNowButton'), nowButtonText = this._get(inst, 'nowButtonText'), showDeselectButton = this._get(inst, 'showDeselectButton'), deselectButtonText = this._get(inst, 'deselectButtonText'), showButtonPanel = showCloseButton || showNowButton || showDeselectButton;
            for (h = hours_options.starts; h <= hours_options.ends; h++) {
                hours.push(h)
            }
            hoursPerRow = Math.ceil(hours.length / rows);
            if (showPeriodLabels) {
        ...
        _generateHTMLMinutes: function(inst) {
            var m, row, html = '', rows = this._get(inst, 'rows'), minutes = Array(), minutes_options = this._get(inst, 'minutes'), minutesPerRow = null, minuteCounter = 0, showMinutesLeadingZero = (this._get(inst, 'showMinutesLeadingZero') == !0), onMinuteShow = this._get(inst, 'onMinuteShow'), minuteLabel = this._get(inst, 'minuteText');
            ...
            minutesPerRow = Math.round(minutes.length / rows + 0.49);
            if (onMinuteShow && (onMinuteShow.apply((inst.input ? inst.input[0] : null), [inst.hours, inst.minutes]) == !1)) {
        ...
        _generateHTMLHourCell: function(inst, hour, showPeriod, showLeadingZero) {
            ...
            if (enabled) {
                if (!isNaN(parseInt(maxTime.hour)) && hour > maxTime.hour)
                    enabled = !1;
                if (!isNaN(parseInt(minTime.hour)) && hour < minTime.hour)
                    enabled = !1
            }
            if (enabled) {
        ...
        _generateHTMLMinuteCell: function(inst, minute, displayText) {
            ...
            if (enabled && hour !== null) {
                if (!isNaN(parseInt(maxTime.hour)) && !isNaN(parseInt(maxTime.minute)) && hour >= maxTime.hour && minute > maxTime.minute)
                    enabled = !1;
                if (!isNaN(parseInt(minTime.hour)) && !isNaN(parseInt(minTime.minute)) && hour <= minTime.hour && minute < minTime.minute)
                    enabled = !1
            }
            if (enabled) {
        ...
        _enableTimepicker: function(target) {
            ...
            if (nodeName == 'input') {
                target.disabled = !1;
                var button = this._get(inst, 'button');
                $(button).removeClass('ui-state-disabled').disabled = !1;
        ...
        _disableTimepicker: function(target) {
            ...
            if (nodeName == 'input') {
                var button = this._get(inst, 'button');
                $(button).addClass('ui-state-disabled').disabled = !0;
                target.disabled = !0;
                inst.trigger.filter('button').each(function() {
                    this.disabled = !0
                }).end()
        ...
        _checkExternalClick: function(event) {
            ...
            if ($target[0].id != $.timepicker._mainDivId && $target.parents('#' + $.timepicker._mainDivId).length == 0 && !$target.hasClass($.timepicker.markerClassName) && !$target.hasClass($.timepicker._triggerClass) && $.timepicker._timepickerShowing && !($.timepicker._inDialog && $.blockUI))
                $.timepicker._hideTimepicker()
        },
        ...
        _setTimeFromField: function(inst) {
            ...
            if ((inst.inline == !1) && (inst.input.val() != '')) {
        ...
        parseTime: function(inst, timeVal) {
            ...
            var timeSeparator = this._get(inst, 'timeSeparator')
              ...
              , showPeriod = (this._get(inst, 'showPeriod') == !0)
        ...
        selectHours: function(event) {
            var $td = $(event.currentTarget)
              ...
              , $target = $(id)
              , inst = this._getInst($target[0])
              , showMinutes = (this._get(inst, 'showMinutes') == !0);
            ...
            this._updateSelectedValue(inst);
            inst._hoursClicked = !0;
            if ((inst._minutesClicked) || (fromDoubleClick) || (showMinutes == !1)) {
                $.timepicker._hideTimepicker()
            }
            return !1
        },
        selectMinutes: function(event) {
            var $td = $(event.currentTarget)
              ...
              , $target = $(id)
              , inst = this._getInst($target[0])
              , showHours = (this._get(inst, 'showHours') == !0);
            if ($.timepicker._isDisabledTimepicker($target.attr('id'))) {
                return !1
            }
            ...
            this._updateSelectedValue(inst);
            inst._minutesClicked = !0;
            if ((inst._hoursClicked) || (fromDoubleClick) || (showHours == !1)) {
                $.timepicker._hideTimepicker();
                return !1
            }
            return !1
        ...
        _getParsedTime: function(inst) {
            ...
            var period = ""
              , showPeriod = (this._get(inst, 'showPeriod') == !0)
              , showLeadingZero = (this._get(inst, 'showLeadingZero') == !0)
              , showHours = (this._get(inst, 'showHours') == !0)
              , showMinutes = (this._get(inst, 'showMinutes') == !0)
              , optionalMinutes = (this._get(inst, 'optionalMinutes') == !0)
              , amPmText = this._get(inst, 'amPmText')
