/*1697686321,,JIT Construction: v1009336620,vi_VN*/
...
try {
                ...
                __d("sdk.XFBML.ChatDOM", ["$InternalEnum", "CORSRequest", "ChatPluginEntryPointIconEnum", "ChatPluginEntryPointLabelEnum", "ChatPluginEntryPointSizeEnum", "ChatPluginSDKPreLoggingUtils", "ChatPluginStyleUtils", "DOMPlugin", "Log", "UrlMap", "getJSEnumSafe", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.IdleCallback", "sdk.XFBML.CustomerChatNew", "sdk.fbt", "sdk.feature", "uuidv4"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        function b(b, e, f, g) {
                            ...
                            j.$ChatDOMFacade3 = document.createElement("div");
                            j.$ChatDOMFacade1 = i.WAITING;
                            j.$ChatDOMFacade2 = !1;
                            j.$ChatDOMFacade6 = !1;
                            j.$ChatDOMFacade8 = "standard";
                            j.$ChatDOMFacade9 = "none";
                            j.$ChatDOMFacade10 = "none";
                            j.$ChatDOMFacade11 = "left";
                            j.$ChatDOMFacade12 = 0;
                            j.$ChatDOMFacade13 = 0;
                            j.$ChatDOMFacade14 = !1;
                            j.$ChatDOMFacade15 = Boolean(g.should_use_new_domain);
                            j.shadowCss = ["css:fb.shadow.css.chatdom"];
                            j.$ChatDOMFacade4 = h();
                            d("Log").info("facadeperf: Started browser idle loader.");
                            j.$ChatDOMFacade5 = new(c("sdk.IdleCallback"))(c("sdk.feature")("chat_plugin_facade_timeout_ms", 8e3), function() {
                                var a = (h || (h = c("performanceAbsoluteNow")))();
                                d("Log").info("facadeperf: Idle callback starts full load in %sms.", a - j.$ChatDOMFacade4);
                                j.$ChatDOMFacade16(!1, !1)
                            }).start();
                            return j
                        }
                        var e = b.prototype;
                        ...
                        e.$ChatDOMFacade20 = function() {
                            if (this.$ChatDOMFacade2 || this.$ChatDOMFacade1 === i.LOADED) return;
                        ...
                        e.$ChatDOMFacade16 = function(a, b) {
                            ...
                            if (this.$ChatDOMFacade1 !== i.WAITING) return;
                            this.$ChatDOMFacade1 = i.LOADING;
                            ...
                            b.subscribe("xd.mpn.setupIconIframe", function(a) {
                                e.$ChatDOMFacade1 = i.LOADED, e.$ChatDOMFacade19()
                            });
                            this.$ChatDOMFacade23(a);
                            b.process()
                        };
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "xfbml.customerchat.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1009336620","namespace":"FB","message":"' + e.message + '"}}');
